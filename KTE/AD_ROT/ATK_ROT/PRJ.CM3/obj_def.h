...
#define   _AD_ROT          // Роторный Выпрямитель ( всё равно , УПТФ или АР2 в АТК ) .
#define   _ATK_ROT         // АТК - АР2 Роторный Выпрямитель .
...
//---
#define  _FP_N_to_L      // ФП Скорости в Угол Управления Роторным Выпрямителем .
//---
