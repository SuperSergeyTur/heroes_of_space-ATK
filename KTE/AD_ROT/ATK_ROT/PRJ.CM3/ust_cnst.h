...
_x_far const  struct  Blok_Ustavok   _c  =
  {
   ...
   /* union Config  Cfg ; */             { _cfg_Kontaktor | _cfg_MT /*| _cfg_DZV*/ | _cfg_Fzapoln | _cfg_Vrasch_Dvig | _cfg2_WatchdogEn//| _cfg_Obj_prg
   ...
   /* word     S_Alfa_Start ;           */   _Grad( 150 ) ,  //_Grad( 120 ) , //_Grad(  90 ) ,
...
//---------------  Для Защит -------------------
   ...
   /* word     Stoyanka_Tok ;           */  _Id_nom  ( 0.90 ) , //_Id_nom  ( 2.00 ) , //65
  ...
  /*----  Для Обработки Дискретных Входов -----*/
   ...
   /* byte     Pi0_Normal ;          ы  */  0xEE, //0x8E, //0x96,
                                            // Есть KF2, нет KF3 - 0xE2 , Есть KF2, есть KF3 - 0xC2 .
   /* byte     Pi1_Normal ;             */  0xE2,//0xC2, //0xCF, /*0xB7,*/ //0x83, //0x8F, //0xBF ,
#ifdef _Pi2_
   ...
   /*    union  CAN_CONFIG config ; */        _can_cfg_bt_250k | _can_cfg_master| _can_cfg_vkl  ,// | _can_cfg_vkl _,
