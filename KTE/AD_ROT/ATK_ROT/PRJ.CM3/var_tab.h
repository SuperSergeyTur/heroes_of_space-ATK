...
// Группа 1  - ТЕКУЩИЕ ПАРАМЕТРЫ ПРИВОДА - 14 - контрольная строка
  ...
  { "cStsRI",  &canr.StatReg2.all,  2, _SHORT_type,  0,         _READ_WRITE_access }, //статус "чужого" КТЭ
  ...
  { "N_Rot",   &Skor_Pusk,          2, _SHORT_type,  _Skor_Nom, _READ_access },   
  { "N_PDF",   &SkorPDF,            2, _SHORT_type,  _Skor_Nom, _READ_WRITE_access }, //скорость ПДФ от АР1
