...
_x_far const struct STB       stb_reg[ ] =
  ...
  { "Id#-макс      ", &_r.OuRSMaxMost1      ,_Id_nom( 0.0 )   ,_Id_nom( 3.5 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном", _form(0,2,2,2) },
    { "Id#-мін       ", &_r.OuRSMaxMost2      ,_Id_nom( 0.0 )   ,_Id_nom( 1.0 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном", _form(0,2,2,2) },
  ...
  { "'Kп-РТ        ", &_r_KRTP              , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  0             , 0xff, "ед" , _form(1,3,2,2) },
    ...
    { "Kп-РС         ", &_r.KRTP              , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  4             , 0xff, "ед" , _form(1,3,2,2) },
...
_x_far const struct Ind  ind_reg[] =
  {
         ...
         { "L#   , L      ", { &S.Alfa         , &S.Alfa_Old    },{_Grad( 1 )     ,_Grad( 1 )      },{ "гp, ","гр"}, {(w*)&_ind_Nom,(w*)&_ind_Nom},{_form(1,3,0,2),_form(0,3,0,2)} },
         { "L    , N      ", { &S.Alfa_Old     , &Skor          },{_Grad( 1 )     ,_Skor_nom(1)    },{ "гp, ","%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(1,3,0,2),_form(0,3,1,2)} },
         { "Fr   , N      ", { &Frot           , &Skor          },{ 1           ,_Skor_nom(1)      },{ "Гц " ,"%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(1,2,1,3),_form(0,3,1,2)} },
...
//         { "Id#  , Id     ", { &canr.Id_zad    , &IDV           },{_Id_Nom        ,_Id_Nom         },{ "%, " ,"%" }, {(w*)&_ind_100,(w*)&_ind_100},{_form(0,3,1,2),_form(0,3,1,2)} },
//         { "ІнтРС, Id     ", { &RT_Str.integr  , &IDV           },{_Grad(1)       ,_Id_Nom         },{ "гр," ,"%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(0,3,1,2),_form(0,3,1,2)} },
//         { "ВихРС, L      ", { &RT_Str.out     , &S.Alfa        },{_Grad(1)       ,_Grad(1)        },{ "гр," ,"гр"}, {(w*)&_ind_Nom,(w*)&_ind_Nom},{_form(0,3,1,2),_form(0,3,1,2)} },
