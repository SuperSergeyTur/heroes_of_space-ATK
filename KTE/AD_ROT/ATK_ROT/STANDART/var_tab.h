...
// Группа 1  - ТЕКУЩИЕ ПАРАМЕТРЫ ПРИВОДА - 14 - контрольная строка
  ...
  { "r0_06",   (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access,       0x200b, _VAR },
  ...
  { "r0_07",   (w*)&crezerv,        2, _SHORT_type,  _Fv_Nom,   _READ_access,       0x2013, _VAR },
  { "r0_08",   (w*)&crezerv,        2, _SHORT_type,  _Fv_Nom,   _READ_access,       0x2014, _VAR },
  { "r0_09",   (w*)&crezerv,        2, _SHORT_type,  _Iv_Nom,   _READ_access,       0x2015, _VAR },
  { "r0_10",   (w*)&crezerv,        2, _SHORT_type,  _Iv_Nom,   _READ_access,       0x2016, _VAR },
  ...
  { "r0_11",   (w*)&crezerv,        2, _SHORT_type,  _Mom_Nom,  _READ_access,       0x201d, _VAR },
...
// Группа 1  - ТЕКУЩИЕ ПАРАМЕТРЫ ПРИВОДА - 14 - контрольная строка
  ...
  { "r0_06",   (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access       },
  ...
  { "r0_07",   (w*)&crezerv,        2, _SHORT_type,  _Fv_Nom,   _READ_access       },
  { "r0_08",   (w*)&crezerv,        2, _SHORT_type,  _Fv_Nom,   _READ_access       },
  { "r0_09",   (w*)&crezerv,        2, _SHORT_type,  _Iv_Nom,   _READ_access       },
  { "r0_10",   (w*)&crezerv,        2, _SHORT_type,  _Iv_Nom,   _READ_access       },
  ...
  { "Lf",      (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access       },
  { "r0_11",   (w*)&crezerv,        2, _SHORT_type,  _Mom_Nom,  _READ_access       },
