...
void init_var_mtab ( void )
{
  ...
  abDev2.ab_addr = _r.AddrDevice2;
  abDev3.ab_addr = _r.AddrDevice3;
...
word can_master ( byte port , byte code )
{
  ...
  //static byte Mtrigg_connect ;
    ...
    reinit:
        ...
        Tst_Read_Dev2 = 0, Tst_Write_Dev2 = 0 ;
        Tst_Read_Dev3 = 0, Tst_Write_Dev3 = 0 ;
        Opros_time = 0 ;
        ...
        {      //  Рассортировка принятых фреймов:
            ...
            do
            {
                ...
                //-----------
                    ...
                    //  Если абонентов больше двух , проверяем, что Мастер и на шину пускаем только мастера ,
                    // чтобы слейвы не перебивали задание от Мастера :
                if ( /*tst_scan == 0 ||*/ _r.Cfg._.CAN_reg == 0 && (u)((w)(ax-time_scan)) > _r.time_scan )
                {
            ...
            *********************************/
                ...
                Tst_Write_Dev2  = master_qwrite(  "\x0\x1\xff" , &abDev2 , mark++ ) ;

                Tst_Write_Dev3  = master_qwrite(  "\x0\x1\xff" , &abDev3 , mark++ ) ;
