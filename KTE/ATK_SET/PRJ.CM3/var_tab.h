...
// Группа 1  - ТЕКУЩИЕ ПАРАМЕТРЫ ПРИВОДА - 14 - контрольная строка
  ...
  { "Ud",      &UdSr,               2, _SHORT_type,  _Ud_Nom,   _READ_access,       0x2002, _VAR },
  { "T-fSec",  &Timer1_fSec,        2, _SHORT_type,  0,         _READ_access,       0x2003, _VAR },
  { "r0_02",   (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access,       0x2004, _VAR },
  { "N#",      &Z_Skor,             2, _SHORT_type,  _Skor_Nom, _READ_access,       0x2005, _VAR },
  { "N#R",     &ZISkor,             2, _SHORT_type,  _Skor_Nom, _READ_access,       0x2006, _VAR },
  { "N",       &Skor,               2, _SHORT_type,  _Skor_Nom, _READ_access,       0x2007, _VAR },
  { "r0_03",   (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access,       0x2008, _VAR },
  { "r0_04",   (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access,       0x2009, _VAR },
  { "Id#",     &OuRegS_dop_kod,     2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200a, _VAR },
  { "Id#R",    &ZIDN,               2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200b, _VAR },
  { "Id",      &Id_dop_kod,         2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200c, _VAR },
#ifdef _SIFU2_
  { "Id2",     &Id2_dop_kod,        2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200d, _VAR },
#else
  { "Id2",     (w*)&crezerv,        2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200d, _VAR },
#endif
#ifdef  Id_sr_ach
  { "Ids",     &Id_sr      ,        2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200e, _VAR },
#else
  { "Ids",     (w*)&crezerv,        2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200e, _VAR },
#endif
#ifdef  Id2_sr_ach
  { "Id2s",    &Id2_sr     ,        2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200f, _VAR },
#else
  { "Id2s",    (w*)&crezerv,        2, _SHORT_type,  _Id_Nom,   _READ_access,       0x200f, _VAR },
#endif
#ifdef _RDN
  { "RDNout",  &RDN_Out,            2, _SHORT_type,  _Skor_Nom, _READ_access,       0x2010, _VAR },
#else
  { "RDNout",  (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access,       0x2010, _VAR },
#endif
  { "L#"    ,  &S.Alfa,             2, _SHORT_type,  _Grad(1),  _READ_access,       0x2011, _VAR },
  { "L"     ,  &S.Alfa_Old,         2, _SHORT_type,  _Grad(1),  _READ_access,       0x2012, _VAR },
#ifndef  _WM591
  { "F#",      &V.Fv_zad,           2, _SHORT_type,  _Fv_Nom,   _READ_access,       0x2013, _VAR },
  { "F",       &V.Fv    ,           2, _SHORT_type,  _Fv_Nom,   _READ_access,       0x2014, _VAR },
  { "If#",     &V.Iv_zad,           2, _SHORT_type,  _Iv_Nom,   _READ_access,       0x2015, _VAR },
  { "If",      &V.Iv,               2, _SHORT_type,  _Iv_Nom,   _READ_access,       0x2016, _VAR },
#else
  { "F#",      (w*)&crezerv,        2, _SHORT_type,  _Fv_Nom,   _READ_access,       0x2013, _VAR },
  { "F",       (w*)&crezerv,        2, _SHORT_type,  _Fv_Nom,   _READ_access,       0x2014, _VAR },
  { "If#",     (w*)&crezerv,        2, _SHORT_type,  _Iv_Nom,   _READ_access,       0x2015, _VAR },
  { "If",      (w*)&crezerv,        2, _SHORT_type,  _Iv_Nom,   _READ_access,       0x2016, _VAR },
#endif
  { "M_Nvs" ,  &S.Most_Tir,         1,_CHAR_type,    0,         _READ_access,       0x2017, _VAR },
#ifdef _SIFU2_
  { "RVTout",  &S2.Out_rvt,         2, _SHORT_type,  _Grad(1),  _READ_access,       0x2018, _VAR },
  { "dL2",     &S2.Alfa,            2, _SHORT_type,  _Grad(1),  _READ_access,       0x2019, _VAR },
  { "M_Nvs2",  &S2.Most_Tir,        1,_CHAR_type,    0,         _READ_access,       0x201a, _VAR },
#else
...
#endif
#ifdef _Vozb_KTE
  { "Lf#",     &V.Alfa,             2, _SHORT_type,  _Grad(1),  _READ_access,       0x201b, _VAR },
  { "Lf",      &V.Alfa_Old,         2, _SHORT_type,  _Grad(1),  _READ_access,       0x201c, _VAR },
#else
  { "Lf#",     (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access,       0x201b, _VAR },
  { "Lf",      (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access,       0x201c, _VAR },
#endif
#ifndef _WM591
  { "M"    ,   &Moment,             2, _SHORT_type,  _Mom_Nom,  _READ_access,       0x201d, _VAR },
#else
  { "M"    ,   (w*)&crezerv,        2, _SHORT_type,  _Mom_Nom,  _READ_access,       0x201d, _VAR },
#endif
#ifdef _RRS
  { "Istat",   &Id_Stat_flt.out,    2, _SHORT_type,  _Id_Nom,   _READ_access,       0x201e, _VAR },
#else
  { "Istat",   (w*)&crezerv,        2, _SHORT_type,  0,         _READ_access,       0x201e, _VAR },
#endif
#ifdef _SIFU2_
  { "Idsum",   &Id_sum,             2, _SHORT_type,  _Id_Nom,   _READ_access,       0x201f, _VAR },
#else
...
// Группа 1  - ТЕКУЩИЕ ПАРАМЕТРЫ ПРИВОДА - 14 - контрольная строка
  ...
  { "N_Rot",   &N_rot,              2, _SHORT_type,  0,         _READ_WRITE_access }, // Скорость по ШИМ от Роторного выпрямителя
  { "I_rot",   &Irot ,              2, _SHORT_type,  _Id_Nom,   _READ_access       },
...
#else
  { "Istat",   &Ist_SA,              2, _SHORT_type,  _Id_Nom,   _READ_WRITE_access },
#endif
#ifdef _SIFU2_
...
// Группа 2  - УПРАВЛЕНИЕ ПРИВОДОМ - 57 - контрольная строка
  ...
  { "cN#",     &canr.N_zad,         2, _SHORT_type,  _Skor_Nom, _READ_WRITE_access }, //задание на скорость от ША  //DAN 12.04.2025
  ...
  { "Idatk",   &canId_zad,          2, _SHORT_type,  _Id_Nom,   _READ_WRITE_access }, // Задание тока от второго АТК .
  { "Ist",     &Ist_SA,             2, _SHORT_type,  0,         _READ_WRITE_access }, // ток статора от ША       //DAN 12.04.2025
...
// Группа 4  - ДИСКРЕТНЫЙ ВВОД-ВЫВОД - 123 - контрольная строка
  ...
  { "AP2A1" ,  &Ap2_Msg.avar                 , 4, _LONG_type,  0,        _READ_access },  
  { "AP2P1" ,  &Ap2_Msg.predupr              , 4, _LONG_type,  0,        _READ_access },  
  { "AP2S1"  , &Ap2_Msg.service              , 4, _LONG_type,  0,        _READ_access }, 
  { "AP2A2" ,  &Ap2_Msg.avar2                , 4, _LONG_type,  0,        _READ_access },  
  { "AP2P2" ,  &Ap2_Msg.predupr2             , 4, _LONG_type,  0,        _READ_access },  
  { "AP2S2" ,  &Ap2_Msg.service2             , 4, _LONG_type,  0,        _READ_access },  
  { "AP2A1h" , &Ap2_Msg.avar.w_reg.h         , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2A1l" , &Ap2_Msg.avar.w_reg.l         , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2P1h" , &Ap2_Msg.predupr.w_reg.h      , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2P1l" , &Ap2_Msg.predupr.w_reg.l      , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2S1h" , &Ap2_Msg.service.w_reg.h      , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2S1l" , &Ap2_Msg.service.w_reg.l      , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2A2h",  &Ap2_Msg.avar2.w_reg.h        , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2A2l",  &Ap2_Msg.avar2.w_reg.l        , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2P2h",  &Ap2_Msg.predupr2.w_reg.h     , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2P2l",  &Ap2_Msg.predupr2.w_reg.l     , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2S2h",  &Ap2_Msg.service2.w_reg.h     , 2, _SHORT_type, 0,        _READ_access },  
  { "AP2S2l",  &Ap2_Msg.service2.w_reg.l     , 2, _SHORT_type, 0,        _READ_access },  
