...
_x_far const  struct  Blok_Ustavok   _c  =
  {
   ...
   /* word     S_Alfa_Start ;           */   _Grad( 120 ) ,

   /* word     S_Alfa_Max ;             */   _Grad( 150 ) ,

   /* word     S_Alfa_Min ;             */   _Grad(  20 ) ,

   /* word     S_DeltaAlfa_Max ;        */   _Grad(  20 ) ,

   /* word     S_ImpLong ;              */   _Grad(   6 ) ,
                                                              //Только для 12-ти пульсных :
   /* word     S_Alfa_IzmId ;           */   _Grad(  14.5 ) , //_Grad(  13 ) , 23.02.2018 - Вычислил Таран с Шестаковым .
...
#ifndef _ZI_30min
   /* word     T_ZISkorP_Razg  ;        */  _Skor_nom( 0.70 ) ,

   /* word     T_ZISkorP_Torm  ;        */  _Skor_nom( 0.70 ) ,

   /* word     T_ZISkorM_Razg  ;        */  _Skor_nom( 0.70 ) ,

   /* word     T_ZISkorM_Torm  ;        */  _Skor_nom( 0.70 ) ,
...
/*------------  Для Модуля Задания на Скорость  -------------------*/
   ...
   /* union     Skor_u   Sk_str ;       */  { _sk_EDS | _sk_FiltrEds | _sk_KompUd_12p } ,
   ...
   /* word     Z_SkMax_P ;              */  _Skor_nom( 1.10 )  ,            //42

   /* word     Z_SkMax_M ;              */  _Skor_nom(-1.10 ) ,             //43
...
#endif
   /* word     Temp_RT_P;               */  30 * _Id_Nom200 , // В старом ЗИРТ 30 ном соответствовало 45 ном/сек ,

   /* word     Temp_RT_M;               */  30 * _Id_Nom200 , // однако оставим 30 ном/сек , чтобы значение не отличалось .
...
//---------------  Для Защит -------------------
   ...
   /* word     Stoyanka_Eds  ;          */  _EDS_nom ( 0.05 ) , //_EDS_nom ( 0.07 ) , //64
  ...
  /*----  Для Обработки Дискретных Входов -----*/
   ...
   /* byte     Pi0_Normal ;          ы  */  0x96, //0xB6, //0xA6, //0xFE ,
                                            // 12-пульс ДЗВ - 0xFF. Есть KF, KFV - 0xB3, Нет KFV - 0xB7, нет KF - 0xF7.
   /* byte     Pi1_Normal ;             */  0xFF,//0xCF, /*0xB7,*/ //0x83, //0x8F, //0xBF ,
#ifdef _Pi2_
   ...
   /*    union  CAN_CONFIG config ; */        _can_cfg_bt_125k  ,// | _can_cfg_vkl _,
   ...
   /*  } ;                          */
#ifdef _CAN_MASTER
     { 0x01, 0x04, _can_cfg_bt_1M | _can_cfg_master | _can_cfg_vkl, _bt0_100k, _bt1_100k, 0x00, 10,  60, 0 }
#else
...
#endif
   /* union Config2  Cfg2 ;             */  { _cfg2_ProboyTir | _cfg2_1VR } ,
