...
// или ОС для РТ и есть Itt :
    ...
    if ( /*Prg._.Gotovn == 0 &&*/ flg_RaTe._.tyr_tst_ok == 1 && bo_Gotov == 0 ) // 12.07.2021
    {
      flg_RaTe._.tyr_tst_ok = 0 ;
    }
#endif
...
word MechTorm_upr ( word num )
{
  ...
  switch ( num )
  {
    ...
    case _MT_Upr :
      ...
      {
  //******
       if ( _r.Cfg2._.MT_Podyom == 0 ) //#ifndef  _MT_Podyom
       {
  //******
        // Растормаживание при наличии задания и +0.5% гистерезиса для исключения дребезга
        if ( bi_QK1 == 1 && bo_Avar == 0 && Prg._.Gotovn == 0 &&
            ( (sw)ZISkor > (sw)_Skor_nom(0.005) || (sw)ZISkor < (sw)_Skor_nom(-0.005) ) )
        {
          bo_MT = 1 ; // Снимаем МТ .
          time_MT = Timer1_Ovr ;
        }
        ...
        {
          if ( bi_QK1 == 0 || bo_Avar == 1 || Prg._.Gotovn == 1 ) bo_MT = 0 ; // при откл. ЛК, или аварии, или в Сб.Гот.
            // Проверка отсутствия вращения двигателя и задания.
          if ( ((sw)Skor <= (sw)_r.Ostanov_skor && (sw)Skor >= (sw)(~_r.Ostanov_skor+1)) && ZISkor == 0 ) bo_MT = 0 ;
 ...
 //#ifdef  _MT_Podyom
      if ( _r.Cfg._.MT == 1 && _r.Cfg2._.MT_Podyom == 1)
      {
     ...
     if ( bi_2P24 != 1 )   //  "КОНТРОЛЬ 2P24"
       ...
       //#endif
          ...
          {                   // успел отпасть контактор.
            ...
            else if ( (u)((b)(Timer1_Ovr-time_VR1)) > _Sec(2.0)) Prz._.VR1 = 0 ;
          }
