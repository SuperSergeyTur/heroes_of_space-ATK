...
#define _KTE_A8_CfgRVId \
    { "Kонфиг.PB-Id" , (w*)&_r.CfgRVId.all, 3 ,                                \
                               { "РВ-включен  ",                               \
                                 "GL1-от-РВ   ",                               \
                                 "GL2-от-РВ   " },                             \
...
#else //_CM3_
     #define _KTE_A8_Pi1 \
      { "Pi1-инверт. " , &_r.Pi1_Normal,  8 ,     /* F16 , F16K */             \
                               {                                               \
                                 "резерв0-P22 ", /*P22*/                       \
                                 "резерв1-P23 ", /*P23*/                       \
                                 "KFV         ", /*P24*/                       \
...
_x_far const struct STB       stb_avar[ ] =
  {
...
#endif
    { "dt-Id-макс    ", &_r.time_Id_max       , 0               ,_pSec( 0.8 )      ,_pSec(1.0)    ,(w*)&_ind_1000, 1             , 0xff, "мc"   , _form(1,3,1,1) }, // !!! Это не "word" , а "byte" , до 255 пульсов .
    ...
    { "dt-If-мин     ", &_r.time_Iv_min       , 0               ,_pSec( 0.8 )      ,_pSec(1.0)    ,(w*)&_ind_1000, 1             , 0xff, "мc"   , _form(1,3,1,1) },
#ifdef _Vozb_KTE
    { "If-макс       ", &_r.Iv_avar_Max       ,_Iv_nom( 0.0 )   ,_Iv_nom( 3.0 )    ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom(0.01)  , 0xff, "ном " , _form(1,2,2,2) },
    { "dt-If-макс    ", &_r.time_Iv_max       , 0               ,_pSec( 0.8 )      ,_pSec(1.0)    ,(w*)&_ind_1000, 1             , 0xff, "мc"   , _form(1,3,1,1) },
#endif
   ...
   #else
    { "T-охлаждения  ", &_r.Time_otkl_BV1     ,_Sec( 0.0 )      ,_Sec(600.0 )      ,_Sec(60.0)    ,(w*)&_ind_Nom, _Sec(1.0)      , 0xff, "мин " , _form(1,2,2,2) },
   #endif
  #else
    { "T-охлаждения  ", &_r.Time_otkl_BV1     ,_Sec( 0.0 )      ,_Sec(3.0 )        ,_Sec(1.0)     ,(w*)&_ind_Nom,  1             , 0xff, "сек " , _form(1,2,2,2) },
  #endif
#endif
#ifdef bo_VklVent // для алгоритма включения вентиляторов по току якоря :
    { "Id-вкл-вентил.", &_or.Id_Vkl_Vent      ,_Id_nom( 0.0 )   ,_Id_nom( 3.5 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom(0.01)  , 0xff, "ном " , _form(1,2,2,2) },
    { "T-откл-вентил.", &_or.T_Otkl_Vent      ,_Sec( 0.0 )      , (sw)0xFFFFu      ,_Sec(60.0)    ,(w*)&_ind_Nom, _Sec(10.0)     , 0xff, "мин " , _form(1,3,1,2) },
#endif
#ifdef _Dat_Temp_Max // для алгоритма аналогового измерения температуры каждого охладителя в каждом силовом шкафу :
    { "T-перегрев-пр.", &_or.T_Pr             , 0.*10           , 300*10           , 10           ,(w*)&_ind_Nom, 10             , 0xff, "гр"   , _form(0,3,1,2) },
    { "T-перегрев-ав.", &_or.T_Av             , 0.*10           , 300*10           , 10           ,(w*)&_ind_Nom, 10             , 0xff, "гр"   , _form(0,3,1,2) },
#endif
    { "T-откл.имп.   ", &_r.Time_do_OtklImp   ,_Sec( 0.1 )      ,_Sec( 9.0 )       ,_Sec(1.0)     ,(w*)&_ind_Nom, _Sec(0.1)      , 0xff, "сек " , _form(1,2,2,2) },
#ifdef bi_Vent_Dvig
    { "T-вентил.двиг.", &_r.Time_otkl_VentDvig,_Sec( 0.0 )      , (sw)0xFFFFu      ,_Sec(60.0)    ,(w*)&_ind_Nom, _Sec(10.0)     , 0xff, "мин " , _form(1,3,1,2) },
#endif
...
#endif
    { "E-стоянка     ", &_r.Stoyanka_Eds      ,_EDS_nom( +0.0 ) ,_EDS_nom( +5.0 )  ,_EDS_Nom      ,(w*)&_ind_Nom, _EDS_nom(0.01) , 0xff, "ном " , _form(1,2,2,2) },
    ...
    { "T-пред.стоянкa", &_r.Stoyanka_Time_Predupr ,_Sec( 0.0 )  ,_Sec( 120.0 )     ,_Sec(1.0)     ,(w*)&_ind_Nom, _Sec(1.0)      , 0xff, "сек " , _form(1,2,0,2) },
...
#ifdef Insul_D_ach
  #ifndef  Uf_ach
    { "Uf-эконом.реж.", &_or.Uf_econom        ,_Uf_nom( 0.00 )  ,_Uf_nom( +2.00 )  , _Uf_Nom      ,(w*)&_ind_Nom, _Uf_nom( 0.01 ), 0xff, "ном " , _form(1,2,2,2) },
  #endif
#endif
    ...
    { "Is-токораспр. ", &_or.Is_tokoraspred   ,_Id_nom( 0.0 )   ,_Id_nom( 3.5 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom(0.01)  , 0xff, "ном " , _form(1,2,2,2) },
#endif
//------------
 #ifndef _CM3_
//------------
...
#endif
#ifdef PUM_ach
    { "ПитаниеУМ-макс", &_r.PUM_max           ,(sw)(-102*9.99)  , (w)(102*9.99)    , 102          ,(w*)&_ind_Nom,  1             , 0xff, " B" , _form(0,2,2,2) },
    { "ПитаниеУМ-мин ", &_r.PUM_min           ,(sw)(-102*9.99)  , (w)(102*9.99)    , 102          ,(w*)&_ind_Nom,  1             , 0xff, " B" , _form(0,2,2,2) },
#endif
#ifdef P12_ach
...
#endif
#ifdef PUM_ach
    { "ПитаниеУМ-макс", &_r.PUM_max ,(sw)(-9.99*_AD_VOLT/2) , (w)(9.99*_AD_VOLT/2) , _AD_VOLT/2   ,(w*)&_ind_Nom,  4             , 0xff, " B" , _form(0,2,2,2) },
    { "ПитаниеУМ-мин ", &_r.PUM_min ,(sw)(-9.99*_AD_VOLT/2) , (w)(9.99*_AD_VOLT/2) , _AD_VOLT/2   ,(w*)&_ind_Nom,  4             , 0xff, " B" , _form(0,2,2,2) },
#endif
#ifdef P12_ach
...
_x_far const struct STB       stb_RS[ ] =
  {
#ifdef  _REG_POL
    { "Порог-dS-РП   ", &_r.DeltaDeadZone     , 0               ,_Grad( 179.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 0.5 )   , 0xff, "гр "  , _form(1,3,2,2) },
    { "Kп-dS-РП      ", &_r.Kp_dP             , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  64            , 0xff, "ед"   , _form(1,3,2,2) },
    { "Kп-РП         ", &_r.Kp_RP             , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  16            , 0xff, "ед"   , _form(1,3,2,2) },
    { "Tи-РП         ", &_r.Ki_RP             , 0               , 999              , 1            ,(w*)&_ind_Nom,  2             , 0xff, "мc"   , _form(1,3,0,2) },
#endif
    { "N#-макс'+'    ", &_r.Z_SkMax_P         ,_Skor_nom( -2.0 ),_Skor_nom( +2.0 ) ,_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(0,2,2,2) },
    { "N#-макс'-'    ", &_r.Z_SkMax_M         ,_Skor_nom( -2.0 ),_Skor_nom( +2.0 ) ,_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(0,2,2,2) },
   ...
   #endif
  #else
    { "ТемпЗИ-РС'+'  ", &_r.T_ZISkorP_Razg    ,_Skor_nom( +0.0 ),_Skor_nom( +10.0 ),_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(1,3,2,2) },
    { "ТемпЗИ-РС'-'  ", &_r.T_ZISkorP_Torm    ,_Skor_nom( +0.0 ),_Skor_nom( +10.0 ),_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(1,3,2,2) },
   #ifdef bi_Reviz
...
#ifdef  TGx_ach
    { "ТГx8-порог    ", &_r.TGx8_porog        ,_Skor_nom( +0.0 ),_Skor_nom( +2.5 ) ,_Skor_nom(0.01),(w*)&_ind_Nom, 4             , 0xff, "%"    , _form(1,3,2,2) },
#endif
...
#ifdef bi_RS_P
    { "Kп-РC (ПИ-рег)", &_r.KRSP              , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  32            , 0xff, "ед"   , _form(1,3,2,2) },
#else
    { "Kп-РC         ", &_r.KRSP              , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  32            , 0xff, "ед"   , _form(1,3,2,2) },
#endif
    { "Tи-РC         ", &_r.KRSI              , 0               , 2000             , 1            ,(w*)&_ind_Nom,  2             , 0xff, "мc"   , _form(1,4,0,2) },
#ifdef bi_RS_P
    { "Kп-РC (П-рег) ", &_r.KRSP_for_P        , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  32            , 0xff, "ед"   , _form(1,3,2,2) },
    { "Темп П/ПИ адап", &_r.Adapt_temp        ,_Id_nom( 0.0 )   ,_Id_nom( 20.0 )   ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.05 ), 0xff, "ном " , _form(1,2,2,2) },
#endif
    ...
    { "Tи-РC-2з.     ", &_r.KRSI_II_Z         , 0               , 999              , 1            ,(w*)&_ind_Nom,  2             , 0xff, "мc"   , _form(1,3,0,2) },
  //{ "Kпип-РC-2з.   ", &_r.KRSPIP_II_Z       , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  32            , 0xff, "ед" , _form(1,3,2,2) },
#ifdef bi_Reviz
    { "Kп-РC-Ревизия ", &_or.KRSP             , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  32            , 0xff, "ед"   , _form(1,3,2,2) },
    { "Tи-РC-Ревизия ", &_or.KRSI             , 0               , 2000             , 1            ,(w*)&_ind_Nom,  2             , 0xff, "мc"   , _form(1,4,0,2) },
    { "Kпип-РC-Ревиз ", &_or.KRSPIP           , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  32            , 0xff, "ед"   , _form(1,3,2,2) },
#endif
...
_x_far const struct STB       stb_RT[ ] =
  ...
  //{ "Id#-макс      ", &_r.IZMAX             ,_Id_nom( 0.0 )   ,_Id_nom( 3.5 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном", 2 },
    { "Id#-макс1'+'  ", &_r.OuRSMaxMost1      ,_Id_nom( 0.0 )   ,_Id_nom( 3.5 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(0,2,2,2) },
    { "Id#-макс1'-'  ", &_r.OuRSMaxMost2      ,_Id_nom(-3.5 )   ,_Id_nom( 0.0 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(0,2,2,2) },
    { "Id#-макс2'+'  ", &_r.OuRSMax2Most1     ,_Id_nom( 0.0 )   ,_Id_nom( 3.5 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(0,2,2,2) },
    { "Id#-макс2'-'  ", &_r.OuRSMax2Most2     ,_Id_nom(-3.5 )   ,_Id_nom( 0.0 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(0,2,2,2) },
    ...
    { "'Ти-РТпреp    ", &_r_KRTPRI            , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  0             , 0xff, "мc"   , _form(1,3,2,2) },
    { "'Ти-РТпреp-AH ", &an_KRTPRI            , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  0             , 0xff, "мc"   , _form(1,3,2,2) },
    { "Ти-РТпреp-уст ", &_r.KRTPRI            , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  1             , 0xff, "мc"   , _form(1,3,2,2) },
    { "'Ти-РТнепp    ", &_r_KRTNI             , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  0             , 0xff, "мc"   , _form(1,3,2,2) },
    { "'Ти-РТнепp-AH ", &an_KRTNI             , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  0             , 0xff, "мc"   , _form(1,3,2,2) },
    { "Ти-РТнепp-уст ", &_r.KRTNI             , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  16            , 0xff, "мc"   , _form(1,3,2,2) },
    { "K-РТ-дин      ", &_r.KRTDI             , 0               , 999              , 1            ,(w*)&_ind_Nom,  1             , 0xff, "ед"   , _form(1,3,0,2) },
#ifdef  _SIFU2_
    { "Id-гр-непp-РТ2", &_or.INN0_2_          ,_Id_nom( 0.0 )   ,_Id_nom( 2.0 )    ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(1,2,2,2) },
    { "'Kп-РТ2       ", &_or_KRTP_2_          , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  0             , 0xff, "ед"   , _form(1,3,2,2) },
    { "'Kп-РТ2-AH    ", &an_KRTP_2_           , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  0             , 0xff, "ед"   , _form(1,3,2,2) },
    { "Kп-РТ2-уст    ", &_or.KRTP_2_          , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  4             , 0xff, "ед"   , _form(1,3,2,2) },
    { "'Ти-РТ2преp   ", &_or_KRTPRI_2_        , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  0             , 0xff, "мc"   , _form(1,3,2,2) },
    { "'Ти-РТ2преp-AH", &an_KRTPRI_2_         , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  0             , 0xff, "мc"   , _form(1,3,2,2) },
    { "Ти-РТ2преp-уст", &_or.KRTPRI_2_        , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  1             , 0xff, "мc"   , _form(1,3,2,2) },
    { "'Ти-РТ2непp   ", &_or_KRTNI_2_         , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  0             , 0xff, "мc"   , _form(1,3,2,2) },
    { "'Ти-РТ2непp-AH", &an_KRTNI_2_          , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  0             , 0xff, "мc"   , _form(1,3,2,2) },
    { "Ти-РТ2непp-уст", &_or.KRTNI_2_         , 0               , (sw)0xFFFFu      , 64           ,(w*)&_ind_Nom,  16            , 0xff, "мc"   , _form(1,3,2,2) },
#endif
    { "РТ-вых-макс   ", &_r.RTMAX             ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,3,0,2) },
    { "РТ-вых-мин    ", &_r.RTMIN             ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,3,0,2) },
#ifdef _DST
    { "T-механизма   ", &_r.T_meh             ,_Id_nom( 0.0 )   , _Id_nom( 30.0 )  ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(1,2,2,2) },
    { "Т-ф-стат.тока ", &_r.T_flt_Stat        ,_fSec( 0.0)      , _fSec( 10 )      ,_fSec(1)      ,(w*)&_ind_Nom, _fSec(0.01)    , 0xff, "сек " , _form(1,2,2,2) },
    { "Кртн.стат.токa", &_r.puls_Istat        , 0               , 100              , 1            ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,0,1) },
#endif
...
_x_far const struct STB       stb_Tormoz[ ] =
  {
    ...
    { "Tзад-контр.МТ ", &_r.Time_MT_Err       ,_Sec( 0.0 )      ,_Sec( 10.0 )      ,_Sec(1.0)     ,(w*)&_ind_Nom,  1             , 0xff, "сек " , _form(1,2,2,2) }
  };
...
_x_far const struct STB       stb_Procat[ ] =
  {
#ifdef _RDN
    { "Порог-РДН     ", &_r.RDN_Dead_Zone     ,_Id_nom( 0.0 )   ,_Id_nom( 2.50 )   ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(1,2,2,2) },
    { "K-РДН         ", &_r.RDN_Kp            , 0               , (sw)0xA000u      , 0x0100*(_Skor_Nom/_Id_Nom) ,(w*)&_ind_Nom,40, 0xff, "ед"   , _form(1,2,2,2) },
    { "dN#-РДН-макс  ", &_r.RDN_Max           ,_Skor_nom( +0.0 ),_Skor_nom( +2.0 ) ,_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(1,2,2,2) },
    { "Tфильтр-РДН   ", &_r.RDN_Tfiltr        , 0               , 999              , 1            ,(w*)&_ind_Nom, 1              , 0xff, "мc"   , _form(1,3,0,2) }
#endif
#ifdef _RRS
  #ifdef _RDN
    ,
  #endif
    { "N#-захвата1   ", &_r.Sk_zahv1          ,_Skor_nom( +0.0 ), _Skor_nom( +2.0 ),_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(1,2,2,2) },
    { "N#-захвата2   ", &_r.Sk_zahv2          ,_Skor_nom( +0.0 ), _Skor_nom( +2.0 ),_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(1,2,2,2) },
    { "Iстат-захвата ", &_r.Porog_Istat       ,_Id_nom( 0.0 )   , _Id_nom( 3.0 )   ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(1,2,2,2) },
    { "T-захвата     ", &_r.T_zahv            ,_fSec( 0.0 )     , _fSec(2.0 )      ,_fSec(1.0)    ,(w*)&_ind_Nom,  _fSec(0.01)   , 0xff, "сек " , _form(1,2,2,2) },
    { "T-лыжи        ", &_r.T_liga            ,_fSec( 0.0 )     , _fSec(2.0 )      ,_fSec(1.0)    ,(w*)&_ind_Nom,  _fSec(0.01)   , 0xff, "сек " , _form(1,2,2,2) },
    { "K-лыжи        ", &_r.K_liga            , 0               , 1*256            , 256          ,(w*)&_ind_Nom,  3             , 0xff, "ед"   , _form(1,3,2,2) }
#endif
#ifdef _BUKSOVKA
  #if defined( _RDN ) || defined( _RRS )
    ,
  #endif
    { "Букс-Id-опред.", &_r.Id_RDN_off        ,_Id_nom( 0.0 )   ,_Id_nom( 2.50 )   ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(1,2,2,2) },
    { "Букс-Id-отпус.", &_r.Id_RDN_on         ,_Id_nom( 0.0 )   ,_Id_nom( 2.50 )   ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(1,2,2,2) },
    { "Букс-N-опред. ", &_r.N_RDN_off         ,_Skor_nom( +0.0 ), _Skor_nom( +2.0 ),_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(1,2,2,2) },
    { "Букс-N-отпус. ", &_r.N_RDN_on          ,_Skor_nom( +0.0 ), _Skor_nom( +2.0 ),_Skor_Nom     ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(1,2,2,2) },
    { "T-опред.букс. ", &_r.Time_Buksov       ,_fSec( 0.0 )     ,_fSec( 12.0 )     ,_fSec(1.0)    ,(w*)&_ind_Nom, _fSec(0.01)    , 0xff, "сек " , _form(1,3,2,2) },
    { "Счетчик букс. ", &_r.count_Buk_f       , 0               , 15               , 1            ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,0,1) }
#endif
  };
#endif
...
_x_far const struct STB       stb_RVId[ ] =
  {
    { "Порог-РВ      ", &_r.RVId_Dead_Zone    ,_Id_nom( 0.0 )   ,_Id_nom( 2.50 )   ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном ", _form(1,2,2,2) },
    { "Kп-PB         ", &_r.RVId_Kp           , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  1             , 0xff, "ед"  , _form(1,3,3,2) },
    { "Tи-PB         ", &_r.RVId_Ti           , 0               , 30000            , 1            ,(w*)&_ind_Nom,  1             , 0xff, "мc"  , _form(1,5,0,2) },
    { "РВ-макс       ", &_r.RVId_Max          ,_Iv_nom( +0.0 )  ,_Iv_nom( +2.0 )   ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom(0.01)  , 0xff, "ном ", _form(1,2,2,2) },
    { "If#-GL1       ", &_r.Iv_zad_GL1        ,_Iv_nom( 0.0 )   ,_Iv_nom( 1.3 )    ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom( 0.01 ), 0xff, "ном ", _form(1,3,2,2) },
    { "If#-GL2       ", &_r.Iv_zad_GL2        ,_Iv_nom( 0.0 )   ,_Iv_nom( 1.3 )    ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom( 0.01 ), 0xff, "ном ", _form(1,3,2,2) }
  };
#endif
...
_x_far const struct STB       stb_SIFU[ ] =
  {
    { "L#-макс       ", &_r.S_Alfa_Max        ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,3,0,2) },
    { "L#-мин        ", &_r.S_Alfa_Min        ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,3,0,2) },
    { "ТемпЗИ-L#     ", &_r.S_DeltaAlfa_Max   ,_Grad( 0.0 )     ,_Grad(  25.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,3,0,2) },
    { "L-измерения-Id", &_r.S_Alfa_IzmId      ,_Grad( 11.5 )    ,_Grad(  20.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 0.1 )   , 0xff, "гр"   , _form(1,3,2,2) },
    { "L-измерения-Ud", &_r.S_Alfa_IzmDoImp   ,_Grad( 1.0 )     ,_Grad(  3.0 )     ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 0.1 )   , 0xff, "гр"   , _form(1,3,2,2) },
#ifndef  _SIFU2_
    { "'Фазир.якоря:N", &_r.S_FazirovVS       , 1               , 6                , 1            ,(w*)&_ind_Nom,  0             , 0xff," ТЕK"  , _form(1,2,0,1) },
    { "'Фазир.якоря:F", &_r.S_FazirovUgol     ,_Grad( 0.0 )     ,_Grad( 60.0 )     ,_Grad(1.0)    ,(w*)&_ind_Nom,  0             , 0xff," гр"   , _form(1,3,0,2) },
#else
    { "'Фазир.ведущ:N", &_r.S_FazirovVS       , 1               , 6                , 1            ,(w*)&_ind_Nom,  0             , 0xff," ТЕK"  , _form(1,2,0,1) },
    { "'Фазир.ведущ:F", &_r.S_FazirovUgol     ,_Grad( 0.0 )     ,_Grad( 60.0 )     ,_Grad(1.0)    ,(w*)&_ind_Nom,  0             , 0xff," гр"   , _form(1,3,0,2) },
    { "'Фазир.ведом:N", &_r.S2.FazirovVS      , 1               , 6                , 1            ,(w*)&_ind_Nom,  0             , 0xff," ТЕK"  , _form(1,2,0,1) },
    { "Kп-РВТ-ведом. ", &_r.S2.Kp_rvt         , 0               , 3000             , 64           ,(w*)&_ind_Nom,  1             , 0xff, "ед"   , _form(1,3,2,2) },
    { "Kи-РВТ-ведом. ", &_r.S2.Ki_rvt         , 0               , 3000             , 64           ,(w*)&_ind_Nom,  1             , 0xff, "ед"   , _form(1,3,2,2) },
    { "РВТ-вых-макс  ", &_r.S2.RVTmax         , 0               , 5*64             , 64           ,(w*)&_ind_Nom,  16            , 0xff, "гр"   , _form(1,2,2,2) },
    { "РВТ-вых-Id-гр ", &_or.RVT_INN0         ,_Grad( -5.0 )    ,_Grad( 5.0 )      ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 0.05 )  , 0xff, "гр"   , _form(0,1,3,2) },
#endif
    { "U0-реверс     ", &_r.RevU0             ,_Grad( 000.0 )   ,_Grad( 180.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,4,0,2) },
    { "Id-реверс     ", &_r.RIDRR             ,_Id_nom( 0.0 )   ,_Id_nom( 0.50 )   ,_Id_Nom       ,(w*)&_ind_Nom, _Id_nom( 0.01 ), 0xff, "ном " , _form(1,2,2,2) },
    { "dt-реверс     ", &_r.dt_revers         , 0               ,_pSec( 10.0 )     ,_pSec(1.0)    ,(w*)&_ind_1000, 1             , 0xff, "мc"   , _form(1,3,1,2) },
    { "K-Kомп-Ud     ", &_r.K_Kompen_Ud       , 0               , 100              , 1            ,(w*)&_ind_Nom,  1             , 0xff, "ед"   , _form(1,3,0,2) },
    { "L#-текущее    ", &S.Alfa               ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,4,2,2) }
  };
...
//  24.06.2020 Закомментировано по указанию КВВ с подачи Овчинникова Л. при разработке нового РЭ.
//  При изменении этой уставки во всем диапазоне влияния на ДЭДС не выявлено.
//  { "K-ЭДС-Т       ", &_r.KEDS_T            , 0               , 255              , 1            ,(w*)&_ind_Nom,  1             , 0xff, "ед"   , _form(1,3,0,1) },
    ...
    { "Tи-РегЭДС     ", &_r.Ki_REDS           , 0               , 999              , 1            ,(w*)&_ind_Nom,  1             , 0xff, "мc"   , _form(1,3,0,2) },
    { "Kп-РегЭДС-2з. ", &_r.DT_ZISk           , 0               , 127*256          , 256          ,(w*)&_ind_Nom,  3             , 0xff, "ед"   , _form(1,4,2,2) },
    { "Tи-РегЭДС-2з. ", &_r.Ki_REDS_II_Z      , 0               , 999              , 1            ,(w*)&_ind_Nom,  1             , 0xff, "мc"   , _form(1,3,0,2) }
  };
...
_x_far const struct STB       stb_Vozb[ ] =
  {
    ...
    { "If#-мин       ", &_r.Iv_zad_Min        ,_Iv_nom( 0.0 )   ,_Iv_nom( 1.3 )    ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom( 0.01 ), 0xff, "ном " , _form(1,3,2,2) },
    { "If#-эконом.   ", &_r.Iv_econom         ,_Iv_nom( 0.0 )   ,_Iv_nom( 1.3 )    ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom( 0.01 ), 0xff, "ном " , _form(1,3,2,2) },
...
#endif
#ifdef _Vozb_KTE
    { "If-удержания  ", &_r.Iv_null           ,_Iv_nom( 0.0 )   ,_Iv_nom( 1.3 )    ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom( 0.01 ), 0xff, "ном " , _form(1,3,2,2) },
    ...
    { "'Фазир.возб.:F", &_r.V_FazirovUgol     ,_Grad( 0.0 )     ,_Grad( 60.0 )     ,_Grad(1.0)    ,(w*)&_ind_Nom,  0             , 0xff," гр"   , _form(1,3,0,2) },
    { "T-отк.имп.воз.", &_r.V_Time_do_OtklImp ,_Sec( 0.1 )      ,_Sec( 6.0 )       ,_Sec(1.0)     ,(w*)&_ind_Nom, _Sec(0.1)      , 0xff, "сек " , _form(1,2,2,1) },
    { "Lf#-мин       ", &_r.V_Alfa_Min        ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad( 1.0)   ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,4,0,2) },
    { "Lf#-макс      ", &_r.V_Alfa_Max        ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad( 1.0)   ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,4,0,2) },
#endif
    { "If#-гашение   ", &_r.Iv_gashen         ,_Iv_nom( -0.1 )  ,_Iv_nom( 1.3 )    ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom( 0.01 ), 0xff, "ном " , _form(0,3,2,2) },
    { "T-гашения поля", &_r.T_gashenie        ,_Sec( 0.0 )      ,_Sec( 600.0 )     ,_Sec(1.0)     ,(w*)&_ind_Nom, _Sec(0.5)      , 0xff, "сек " , _form(1,3,2,2) },
    { "If#-текущее   ", &V.Iv_zad             ,_Iv_nom( 0.0 )   ,_Iv_nom( 1.3 )    ,_Iv_Nom       ,(w*)&_ind_Nom, _Iv_nom( 0.01 ), 0xff, "ном " , _form(0,3,2,2) }
#ifdef _Vozb_KTE
   ,{ "Lf#-текущее   ", &V.Alfa               ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,4,2,2) }
#endif
  };
...
_x_far const struct STB       stb_masht[ ] =
  ...
  //{ "Id-масштаб    ", &_r.Mashtab_Id        , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 3              , 0xff, "ед" , 2 },
    { "Id-ном-Двиг.  ", &_sr.NOM.Id.fe        , 0               , (sw)0xffff-100   , 1            ,(w*)&_ind_Nom, 1              , 0xff, " A"   , _form(1,5,0,2) },
    { "Id-ном-ДТ     ", &_sr.Dat.Id           , 0               , 0x7fff           , 1            ,(w*)&_ind_Nom, 1              , 0xff, " A"   , _form(1,5,0,2) },
    { "'Id-макс-ДТ   ", &Mashtab.Id_max       , 0               , _Id_nom( 7.0 )   , _Id_Nom      ,(w*)&_ind_Nom, 0              , 0xff, "ном " , _form(1,2,2,2) },
    { "'Id-масштаб   ", &Mashtab.Id           , 0               , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 0              , 0xff, "ед"   , _form(1,3,2,2) },
  //{ "Ud-масштаб    ", &_r.Mashtab_Ud        , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 3              , 0xff, "ед" , 2 },
    { "Ud-ном-Двиг.  ", &_sr.NOM.Ud.fe        , 0               , (sw)0xffff-100   , 1            ,(w*)&_ind_Nom, 1              , 0xff, " B"   , _form(1,5,0,2) },
    ...
    { "'Ud-масштаб   ", &Mashtab.Ud           , (sw)0xF700      , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 0              , 0xff, "ед"   , _form(1,3,2,2) },
  //{ "If-масштаб    ", &_r.Mashtab_Iv        , 0               , 0x0EFF           , 0x0100       ,(w*)&_ind_Nom, 3              , 0xff, "ед" , 2 },
...
#ifdef  TGx_ach
    { "ТГx8-масштаб  ", &_r.Mashtab_OS_TGx    , (sw)0xF600      , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) },
#endif
#ifdef  EDS_ach
    { "Eаппар-масштаб", &_r.Mashtab_EDS       , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,3,2) },
#endif
#ifdef   Itt_ach
    ...
    { "Is-масштаб    ", &_r.Mashtab_Idtt      , 0               , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,3,2) },
#endif
#ifdef   Id_sum_ach
    { "Id-сум-масштаб", &_or.Mashtab_Id_sum   , 0               , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,3,2) },
#endif
#ifdef   It_ach
    { "It-масштаб    ", &_r.Mashtab_It        , 0               , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,3,2) },
#endif
  ...
  //{ "N(Eпр)-масштаб", &_or.Mashtab_Npr_po_EDS,0               , 0x1400           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,3,2) },
    ...
    { "Id-2d-масштаб ", &_r.Mashtab_Id_2v     , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,3,2) },
#endif
#ifdef N_2v_ach  // Измерение канала N-2вал :
    { "N-2d-масштаб  ", &_r.Mashtab_N_2v      , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,3,2) },
#endif
  //{ "K-перегруз    ", &_r.Koef_Id_teplo     , 0               , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 3              , 0xff, "ед"   , _form(1,3,2,2) },
    { "ПДФ0-имп/об.  ", &_r.PDF[0].imp        , 0               , 0x7fff           , 1            ,(w*)&_ind_Nom, 2              , 0xff, "ед"   , _form(1,5,0,2) },
  //{ "ПДФ-нуль      ", &_r.PDF[0].null       ,_Grad(-179.0 )   ,_Grad(+179.0 )    ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(0,3,1,2) },
  ...
  //{ "ПДФ0-масштаб  ", &_r.PDF[0].masht      , 0               , (sw)0xFFFFu      ,_PDF_delitel  ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,2,3,2) },
    { "N-ном-Двиг.   ", &_sr.NOM.N.fe         , 0               , (sw)0xffff-100   , 1            ,(w*)&_ind_Nom, 2              , 0xff, "об/мин ", _form(1,5,0,2) },
#ifdef _Sels_shift0
    { "Сельс0g-K-фил.", &_or.Sels_shift0      , 0               , 7                , 1            ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,0,1) },
#endif
    { "Сельс0g-нуль  ", &_r.Selsin[0].null    ,_Grad(-179.0 )   ,_Grad(+179.0)     ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 0.25 )  , 0xff, "гр"   , _form(0,3,1,2) },
#ifdef _Sels_mashtP0
    { "Сельс0m-мсш'+'", &_or.Sels_mashtP0     , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 3              , 0xff, "ед"   , _form(1,3,2,2) },
#endif
#ifdef _Sels_mashtM0
    { "Сельс0m-мсш'-'", &_or.Sels_mashtM0     , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 3              , 0xff, "ед"   , _form(1,3,2,2) },
#endif
    { "Сельс0m-масшт.", &_r.Selsin[0].masht   , (sw)0xF000      , 0x0F00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,1,3,2) },
#ifdef _Sels_shift1
    { "Сельс1g-K-фил.", &_or.Sels_shift1      , 0               , 7                , 1            ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(1,3,0,1) },
#endif
    { "Сельс1g-нуль  ", &_r.Selsin[1].null    ,_Grad(-179.0 )   ,_Grad(+179.0)     ,_Grad(1.0)    ,(w*)&_ind_Nom, _Grad( 0.25 )  , 0xff, "гр"   , _form(0,3,1,2) },
#ifdef _Sels_mashtP1
    { "Сельс1m-мсш'+'", &_or.Sels_mashtP1     , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 3              , 0xff, "ед"   , _form(1,3,2,2) },
#endif
#ifdef _Sels_mashtM1
    { "Сельс1m-мсш'-'", &_or.Sels_mashtM1     , 0               , 0x09FF           , 0x0100       ,(w*)&_ind_Nom, 3              , 0xff, "ед"   , _form(1,3,2,2) },
#endif
    { "Сельс1m-масшт.", &_r.Selsin[1].masht   , (sw)0xF000      , 0x0F00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,1,3,2) },
#ifdef _Rev_Pola
    { "Id#/F#-масштаб", &_r.Mashtab_Idz_Ivz   , (sw)0xF000      , 0x7fff           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,1,3,2) },
#endif
#ifdef  Ttrans_ach
    { "Кф-парам.     ", &_or.Filtr_Param      , 1               , 100              , 1            ,(w*)&_ind_Nom, 1              , 0xff, "ед "  , _form(1,4,1,2) },
    { "Ttr-предупр.  ", &_or.Ttr_predupr      , 0               ,  300*10          , 10           ,(w*)&_ind_Nom, 10             , 0xff, "гр"   , _form(0,3,0,2) },
    { "Ttr-4мА       ", &_or.Ttr_4mA          , -50.*10         ,  300*10          , 10           ,(w*)&_ind_Nom, 10             , 0xff, "гр"   , _form(0,3,0,2) },
    { "Ttr-20мА      ", &_or.Ttr_20mA         , 0               ,  300*10          , 10           ,(w*)&_ind_Nom, 10             , 0xff, "гр"   , _form(0,3,0,2) }
#endif
#ifdef _DAC_OFFSET
    { "'DAC0-смещ.0  ", &_or.dac_numb[0].offset,_DAC_setka_min,_DAC_setka_max,_DAC_setka_max      ,(w*)&_ind_100, 0              , 0xff, "%  "  , _form(0,3,1,2) },
// #ifndef _CM3_  10.07.2017 8:21 DAC1 - задание на If
    { "'DAC1-смещ.0  ", &_or.dac_numb[1].offset,_DAC_setka_min,_DAC_setka_max,_DAC_setka_max      ,(w*)&_ind_100, 0              , 0xff, "%  "  , _form(0,3,1,2) },
// #endif
#endif
    { "DAC0-масштаб  ", &_or.dac_numb[0].mashtab, (w)0xF700     , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) },
    { "DAC1-масштаб  ", &_or.dac_numb[1].mashtab, (w)0xF700     , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) }
#if defined(_PPG_for_DAC2) || !(defined(_CM3_) || defined(_FR50N_)) // Для F16K DAC2 определен
   ,{ "DAC2-масштаб  ", &_or.dac_numb[2].mashtab, (w)0xF700     , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) }
#endif
#ifdef  _PPG_for_DAC3
   ,{ "DAC3-масштаб  ", &_or.dac_numb[3].mashtab, (w)0xF700     , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) }
#endif
#ifdef  _PPG_for_DAC4
   ,{ "DAC4-масштаб  ", &_or.dac_numb[4].mashtab, (w)0xF700     , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) }
#endif
#ifdef  _PPG_for_DAC5
   ,{ "DAC5-масштаб  ", &_or.dac_numb[5].mashtab, (w)0xF700     , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) }
#endif
#ifdef  _PPG_for_DAC6
   ,{ "DAC6-масштаб  ", &_or.dac_numb[6].mashtab, (w)0xF700     , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) }
#endif
#ifdef  _PPG_for_DAC7
   ,{ "DAC7-масштаб  ", &_or.dac_numb[7].mashtab, (w)0xF700     , 0x0A00           , 0x0100       ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,3,3,2) }
#endif
  };
...
_x_far const struct STB       stb_serv[ ] =
  {
    { "След-крат.    ", &sled.kratn           , 0               , 31               , 1000         ,(w*)&sled.dt_scan, 1          , 0xff, "мс"   , _form(1,3,2,2) },
#ifdef _JOURNAL
    { "Журнал-крат.  ", &TabJrn.dt_scan       , _fSec(0)        , _fSec(5.0)       , _fSec(1.0)   ,(w*)&_ind_Nom, _fSec(0.01)    , 0xff, "сек " , _form(1,1,2,2) },
#endif
#ifdef _WatchDog
    { "Время WatchDog", &_r.WD_time           , 0               ,1100              , 1            ,(w*)&_ind_Nom, 50             , 0xff, "мс"   , _form(1,4,0,2) },
#endif
  //{ "След-скан.    ", &sled.dt_scan         , 0               ,_MkSec(50u*1000u) ,_MkSec(1000)  ,(w*)&_ind_Nom, _MkSec(100)    , 0xff, "мс"   , _form(1,2,2,2) },
    { "cS#           ", &canr.S_zad           ,_Grad( 0.0 )     ,_Grad( 359.0 )    ,_Grad( 1.0)   ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(0,4,0,2) },
    ...
    { "cL#           ", &canr.L_zad           ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad( 1.0)   ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,4,0,2) },
    { "cL#min        ", &canr.L_min           ,_Grad( 0.0 )     ,_Grad( 179.0 )    ,_Grad( 1.0)   ,(w*)&_ind_Nom, _Grad( 1.0 )   , 0xff, "гр"   , _form(1,4,0,2) },
    ...
    { "Tаймаут CAN0  ", &_r.can[0].connect    , 0               , 100              , 1            ,(w*)&_ind_Nom, 1              , 0xff, "мс"   , _form(1,3,0,1) },
    ...
    { "Tаймаут CAN1  ", &_r.can[1].connect                         , 0    , 100    , 1            ,(w*)&_ind_Nom, 1              , 0xff, "мс"   , _form(1,3,0,1) },
...
#ifdef _CAN2_Port
   ,{ "Tаймаут CAN2  ", &_r.can[2].connect                         , 0    , 100    , 1            ,(w*)&_ind_Nom, 1              , 0xff, "мс"   , _form(1,3,0,1) },
...
const _x_far struct STB       stb_ADC_masht[ ] =
  {
    { "Масштаб n0    ", &_ar.ADC_Scale[0]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n1    ", &_ar.ADC_Scale[1]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n2    ", &_ar.ADC_Scale[2]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n3    ", &_ar.ADC_Scale[3]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n4    ", &_ar.ADC_Scale[4]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n5    ", &_ar.ADC_Scale[5]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n6    ", &_ar.ADC_Scale[6]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n7    ", &_ar.ADC_Scale[7]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n8    ", &_ar.ADC_Scale[8]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n9    ", &_ar.ADC_Scale[9]  , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n10   ", &_ar.ADC_Scale[10] , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n11   ", &_ar.ADC_Scale[11] , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n12   ", &_ar.ADC_Scale[12] , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n13   ", &_ar.ADC_Scale[13] , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n14   ", &_ar.ADC_Scale[14] , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) },
    { "Масштаб n15   ", &_ar.ADC_Scale[15] , ach_scale_min , ach_scale_max , def_ach_scale        ,(w*)&_ind_Nom, 1              , 0xff, "ед" , _form(1,1,4,2) }
 };
#endif
...
_x_far const struct STB       stb_shtat[ ] =
  {
    ...
    { "N#-Тол.Вперед ", &_r.ZSk_TB            ,_Skor_nom( -2.00),_Skor_nom( +2.00 ), _Skor_Nom    ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(0,2,2,2) },
    { "N#-Тол.Назад  ", &_r.ZSk_TH            ,_Skor_nom( -2.00),_Skor_nom( +2.00 ), _Skor_Nom    ,(w*)&_ind_Nom, _Skor_nom(0.01), 0xff, "ном " , _form(0,2,2,2) },
    { "N#-порог      ", &_r.Z_SkMin           ,_Skor_nom( +0.00),_Skor_nom( +0.50 ), _Skor_nom( +0.01 ) ,(w*)&_ind_Nom, 8        , 0xff, "%"    , _form(1,2,2,2) }
#ifdef  Nzad_4_20_ach
   ,{ "Кф-парам-N#.  ", &_or.Filtr_Param_Nzad , 1               , 100              , 1            ,(w*)&_ind_Nom, 1              , 0xff, "ед "  , _form(1,4,1,2) },
...
_x_far const struct STB       stb_anastr[ ] =
  {
  //{ "Tпп РТ-непрер.", &_r.Tpp_AN_nepr       , 3               , 2000             , 1            ,(w*)&_ind_Nom, 1              , 0xff, "мс"   , _form(1,3,0,2) },
    { "Tпп РТ-прерыв.", &_r.Tpp_AN_pr         , 3               , 2000             , 1            ,(w*)&_ind_Nom, 1              , 0xff, "мс"   , _form(1,3,0,2) },
    { "Коэф.Демпф.РТ ", &_r.KoefDempfirRT     , (w)(0.25*256.)  , 2 * 256          , 256          ,(w*)&_ind_Nom, 1              , 0xff, "ед"   , _form(0,2,3,2) },
    { "Id-гр-непp-90g", &_r.INN_def_AN        , 0               , 1                , 1            ,(w*)&_ind_Nom, 1              , 0xff, " "    , _form(1,1,0,2) },
    { "Te            ", &_r.Te_AN             , 0               , 120 * 64         , 64           ,(w*)&_ind_Nom, 64             , 0xff, "мс"   , _form(1,3,0,2) },
  //------ 11.01.2022 - DAN убрал, эти параметры нужны были для Соломахи, кроме него в них никто не разберется...
  //{ "'Ктп/Ra_непр. ", &_r.KtpRa_AN_nepr     , 0               , 120 * 64         , 64           ,(w*)&_ind_Nom, 0              , 0xff, "ед"   , _form(1,3,2,2) },
  //{ "'Ктп/Ra_прер. ", &_r.KtpRa_AN_pr       , 0               , 120 * 64         , 64           ,(w*)&_ind_Nom, 0              , 0xff, "ед"   , _form(1,3,2,2) }
  //------
  //{ "Tm            ", &_r.Tm_AN             , 0               , 1000             , 1            ,(w*)&_ind_Nom, 1              , 0xff, "мс"   , _form(1,3,0,2) },
  //{ "TопрМакс-Tm   ", &_r.T_AN_ust          , _fSec( 0.0 )    , _fSec( 16.0 )    , _fSec(1)     ,(w*)&_ind_Nom, _fSec(1)       , 0xff, "сек " , _form(1,2,1,2) },
  //{ "L0 (Tm АН)    ", &_r.Alfa0_forTm_AN    , _Grad(60)       , _Grad(85)        , _Grad(1)     ,(w*)&_ind_Nom, _Grad(5)       , 0xff, "гр"   , _form(1,2,0,2) },
...
const struct UstUzm   Ustav[] =
  {
//  { "Регулирование " ,sizeof(stb_reg   )/sizeof(struct STB) ,(_x_far const struct STB*)&stb_reg   [0] },
    { "Рег. скорости " ,sizeof(stb_RS    )/sizeof(struct STB) ,(_x_far const struct STB*)&stb_RS    [0] },
    { "Регулятор токa" ,sizeof(stb_RT    )/sizeof(struct STB) ,(_x_far const struct STB*)&stb_RT    [0] },
    { "СИФУ          " ,sizeof(stb_SIFU  )/sizeof(struct STB) ,(_x_far const struct STB*)&stb_SIFU  [0] },
    { "ЭДС           " ,sizeof(stb_EDS   )/sizeof(struct STB) ,(_x_far const struct STB*)&stb_EDS   [0] },
    { "Возбуждение   " ,sizeof(stb_Vozb  )/sizeof(struct STB) ,(_x_far const struct STB*)&stb_Vozb  [0] },
    { "Тормоз        " ,sizeof(stb_Tormoz)/sizeof(struct STB) ,(_x_far const struct STB*)&stb_Tormoz[0] },
#if defined( _RDN ) || defined( _RRS ) || defined( _BUKSOVKA )
    { "Прокат        " ,sizeof(stb_Procat)/sizeof(struct STB) ,(_x_far const struct STB*)&stb_Procat[0] },
#endif
#ifdef _RVId
...
#ifdef _CM3_
    { "Масштабы АЦП  " ,sizeof(stb_ADC_masht)/sizeof(struct STB) ,&stb_ADC_masht[0] },
#endif
    { "Штатное управ." ,sizeof(stb_shtat )/sizeof(struct STB) ,(_x_far const struct STB*)&stb_shtat [0] },
#ifdef _AVTONASTR
    { "Автонастройка " ,sizeof(stb_anastr)/sizeof(struct STB) ,(_x_far const struct STB*)&stb_anastr[0] },
#endif
...
#ifdef _A7_Obj_Ust
   ,{ "Объект. управ." ,sizeof(stb_obj   )/sizeof(struct STB) ,(_x_far const struct STB*)&stb_obj   [0] }
#endif
#ifdef  _INTERPRETER
   ,{ "Объект. прогр." ,sizeof(Ust_Obj_Prg)/sizeof(struct Obj_STB) ,(_x_far const struct STB*)&Ust_Obj_Prg[0] }
#endif
...
_x_far const struct Ind  ind_reg[] =
  {
...
#endif
#ifdef  Nzad_4_20_ach
         { "N#(4-20)      ", { &Nzad_4_20      , &Nzad          },{_1mA_Nom       ,_Skor_nom(1)    }, {"мА," ,"%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(0,2,1,2),_form(0,3,0,2)} },
#endif
       //{ "dN   , РСпип-p", { &Delta_Sk       , &OuIchRS_k     },{_Skor_nom(1)   ,_Id_Nom         },{ "%, " ,"%" }, {(w*)&_ind_100,(w*)&_ind_100},{_form(0,3,0,2),_form(0,3,0,2)} },
...
#ifdef   EDS_ach
         { "Eаппар, Eпрогp", { &iEDS           , &prEDS         },{_EDS_nom(1)>>_Skor_Shift ,_EDS_nom(1)>>_Skor_Shift },{ "%, " ,"%" }, {(w*)&_ind_100,(w*)&_ind_100},{_form(0,3,0,2),_form(0,3,0,2)} },
#endif
         ...
         { "РТВи-р,If     ", { &V.Integr_rt    , &V.Iv          },{_Grad( 1 )     ,_Iv_Nom         },{ "гp, ","%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(1,3,0,2),_form(0,3,0,2)} },
#endif
         ...
         { "РТи-p, Id-p   ", { &OIRT           , &IDN           },{_Grad( 1 )     ,_Id_Nom         },{ "г,"  ,"%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(1,3,1,2),_form(1,3,1,2)} },
#else
         ...
         { "РТ1и-p,Id1-p  ", { &OIRT           , &IDN           },{_Grad( 1 )     ,_Id_Nom         },{ "г,"  ,"%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(1,3,1,2),_form(1,3,1,2)} },
         { "РТ2и-p,Id2-p  ", { &OIRT_2_        , &IDN_2_        },{_Grad( 1 )     ,_Id_Nom         },{ "г,"  ,"%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(1,3,1,2),_form(1,3,1,2)} },
#endif
#ifdef Itt_ach
...
#ifdef Insul_D_ach
         { "Uf   ,  Uизвд ", { &Uf             , &UinsulD      }, {_Ud_Nom     ,(w)(1.0*(_AD_MAX/5.0))    }, {"%,","B"}, {(w*)&_ind_100,(w*)&_ind_Nom}, {_form(0,3,1,2),_form(0,1,2,2)} },
         { "Uизвд,Uиз.макc", { &UinsulD        , &UinsulD_max  }, {(w)(1.0*(_AD_MAX/5.0)), (w)(1.0*(_AD_MAX/5.0))},{"В, ","B"}, {(w*)&_ind_Nom,(w*)&_ind_Nom}, {_form(0,1,2,2),_form(0,1,2,2)} },
#endif
#ifdef  _T_PDF
...
#else
         { "ПДФ0:об/мин, %", { &PDF[0].out_ob  , &PDF[0].out_m  },{ 1             ,_Skor_Nom       },{ ", "  ,"%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(0,4,0,2),_form(0,3,0,2)} },
#endif
#ifdef TG_ach
...
_x_far const struct Ind  ind_serv[] =
  {
    ...
    // 12-ти пульсная схема , по два ШС в каждом мосту - индикация второй секции :
       ...
       _A6_ADC_multiplex_temp,
         ...
         { "cS#  ,  cN#   ", { &canr.S_zad     , &canr.N_zad      },{_Grad( 1 )     ,_Skor_Nom       },{ "гр, ","%" }, {(w*)&_ind_Nom,(w*)&_ind_100},{_form(0,3,0,2),_form(0,3,0,2)} },
...
#endif
         { "Tckl  , StopP ", { &Tckl, &stop_point       }, { _MkSec(1000), 1          },{ "мс, ",""  }, {(w*)&_ind_Nom, (w*)&_ind_Nom } ,{_form(1,2,1,2),_form(1,3,0,1)} },
...
_x_far const struct Ind  ind_RVId[] =
  {
         ...
         { "Id1  , Id2 (А)", { &RVId.Id1      , &RVId.Id2     },{_Id_Nom        ,_Id_Nom         },{ ", "  ," " }, {(w*)&_sr.NOM.Id.fe,(w*)&_sr.NOM.Id.fe},{_form(0,5,0,2),_form(0,5,0,2)} },
         { "If   , If2 (А)", { &V.Iv          , &V2.Iv        },{_Iv_Nom*10     ,_Iv_Nom*10      },{ ", "  ," " }, {(w*)&_sr.NOM.Iv.fe,(w*)&_sr.NOM.Iv.fe},{_form(0,2,1,2),_form(0,2,1,2)} }
  };
#endif
...
{
    { "Регулирование " ,sizeof(ind_reg )/sizeof(struct Ind) ,(_x_far const struct Ind*)&ind_reg [0] },
#ifdef _A6_Obj_Ind
    { "Объект. управ." ,sizeof(ind_obj )/sizeof(struct Ind) ,(_x_far const struct Ind*)&ind_obj [0] },
#endif
#if defined( _RDN ) || defined( _RRS ) || defined( _BUKSOVKA )
...
#ifdef  _INTERPRETER
   ,{ "Объект. прогр." ,sizeof(Ind_Obj_Prg)/sizeof(struct Ind_obj ) ,(_x_far const struct Ind*)(&Ind_Obj_Prg[0]) }
#endif
};
...
_x_far const struct COMB_MENU comb_menu[] =
{
     ...
     _OBJ_COMB_REDACT,
#endif
    { "N#-масштаб - N#a", &_r.Mashtab_ZSkA,  0, 0x1400, 0x0100, (w*)&_ind_Nom, 1, "ед", _form(1,3,3,2),
                  /*ind*/ &ZSkA, _Skor_Nom , "%",               (w*)&_ind_100,          _form(0,3,0,2)},
    { "ТГ-масштаб - ТГ ", &_r.Mashtab_OS_TG, 0, 0x1400, 0x0100, (w*)&_ind_Nom, 1, "ед", _form(1,3,3,2),
                  /*ind*/ &TG,   _Skor_Nom , "%",               (w*)&_ind_100,          _form(0,3,0,2)},
    { "Сельс0: масш.-% ", &_r.Selsin[0].masht, (sw)0xF000, 0x0F00, 0x0100, (w*)&_ind_Nom, 1, "ед", _form(0,1,3,2),
...
_x_far const struct DAC_output_tab2 DAC_tab2  [ ] =                //          |    |  _SIFU2_   | _SIFU2_
  {                                                                //          |    |            |
    ...
    { "Id1-средн.",  &Id_sr        , (  1.00 * 256./_K_diskr ) },  //-         | -  | 12         | 11
    { "Id2       ",  &Id2_dop_kod  , (  1.00 * 256./_K_diskr ) },  //-         | -  | 13         | 12
    { "Id2-средн.",  &Id2_sr       , (  1.00 * 256./_K_diskr ) },  //-         | -  | 14         | 13
...
_x_far const struct Ck  Nckl [ ] =
  {
   ...
   { "РT         \r", _Id_nom( -2.0) , _Id_nom(+2.0)  , _Id_Nom    , _Id_nom(0.01)   },
#ifdef _Rev_Pola
   { "РТВ-двиг.  \r", _Iv_nom(-2.0)  , _Iv_nom(2.0)   , _Iv_Nom    , _Iv_nom(0.01)   },
#else
...
// { "РЭДС       \r", _EDS_nom(0.0)  , _EDS_nom(+1.0) , _EDS_Nom   , _EDS_nom(0.01)  },
   { "СИФУ       \r", _Grad(0.0)     , _Grad(179.0)   , _Grad(1.0) , _Grad(0.05)     },
   { "РП         \r", _Grad(-179.0)  , _Grad(179.0)   , _Grad(1.0) , _Grad(0.05)     }
#ifdef _SIFU2_
  ,{ "РT1        \r", _Id_nom( -2.0) , _Id_nom(+2.0)  , _Id_Nom    , _Id_nom(0.01)   },
   { "РT2        \r", _Id_nom( -2.0) , _Id_nom(+2.0)  , _Id_Nom    , _Id_nom(0.01)   }
#endif
  } ;
...
#endif
#ifdef   _AVTONASTR
                                 { "\rАвтонастройка  ",  25},//k60a},
#endif
#ifdef   _NARABOTKA
                                 { "\rОбнул.наработки",  33},//k67 },
#endif
#ifdef _SELS_NULL
                                 { "\rУст.нуля сельс.", 37 },//k71 },
#endif
                                 { "\rФункц.'F#->If#'",  7 },//k14 },
