...
// Группа 1  - ТЕКУЩИЕ ПАРАМЕТРЫ ПРИВОДА - 14 - контрольная строка
  ...
  { "E",       &EDS_dop_kod,        2, _SHORT_type,  _EDS_Nom,  _READ_access,       0x2001, _VAR },
...
#endif
#ifdef _DST
  { "IstF",    &Id_Stat_flt.out,    2, _SHORT_type,  _Id_Nom,   _READ_access,       0x201e, _VAR },
#else
  { "IstF",    (w*)&crezerv,        2, _SHORT_type,  _Id_Nom,   _READ_access,       0x201e, _VAR },
#endif
#ifdef _SIFU2_
...
#else
  { "PDF0o" ,  &PDF[0].out_ob,      2, _SHORT_type,  1,         _READ_access,       0x2051, _VAR },
#endif
#else
...
// Группа 1  - ТЕКУЩИЕ ПАРАМЕТРЫ ПРИВОДА - 14 - контрольная строка
  ...
  { "E",       &EDS_dop_kod,        2, _SHORT_type,  _EDS_Nom,  _READ_access       },
...
#endif
#ifdef _DST
  { "IstF",    &Id_Stat_flt.out,    2, _SHORT_type,  _Id_Nom,   _READ_access       },
#else
  { "IstF",    (w*)&crezerv,        2, _SHORT_type,  _Id_Nom,   _READ_access       },
#endif
#ifdef _SIFU2_
