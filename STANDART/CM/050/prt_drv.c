  ...
  {    //  Стартовая инициализация.
    case 0 :
         al = ( (((b)(LPC_GPIO2->PIN >> 11) & 0x07)       |          // 0й бит - Dint1 - разъём Х6/1
                ...
                (((b)(LPC_GPIO1->PIN >>  1) & 0x01) << 4) |          // 4й бит - KF - предохранитель вых.каскадов F2
                (((b)(LPC_GPIO0->PIN >>  5) & 0x01) << 5) |          // 5й бит - Mode1 - джампер J1
                (((b)(LPC_GPIO0->PIN >>  4) & 0x01) << 6)) & 0x7F ); // 6й бит - Mode2 - джампер J2
        Pi0_c.all = al ;
        Pi0_cf.all = al ;
