...
//  LPC_IOCON->P4_30 = D_RESERV | D_MODE_PULLUP | 0x1;  // EMC.CS0    // В ВТЕ отсутствует
...
//-------------------------------------------------------------------------------------
 //   emcx = EMC_Check( _EMC_CS0 );     // В ВТЕ отсутствует
 ...
 * -1 = даныые все верны
 * -2 = указанная область памяти не обслуживаетс
 * --------------------------------------------------*/
