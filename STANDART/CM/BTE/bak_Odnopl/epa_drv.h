...
#define _ICS0_PRIORITY   IntPriority(3, 1)  //???
#define _ICS1_PRIORITY   IntPriority(3, 1)  //???
#define _ICS23_PRIORITY  IntPriority(3, 1)  //???
...
#define _OCS5 ( 0x5 )  //LPC_TIM2->MR3
        ...
        // приоритет ЕПА - минимальный возможный.
#define _OCS1_PRIORITY   IntPriority(3, 1) //    (3, 1) для того, чтоб приоритет СИФУ можно было сделать чуть выше
#define _OCS2_PRIORITY   IntPriority(3, 1) //    (в extern.h -> #define   _sifu_high_priority  IntPriority(3, 0))
