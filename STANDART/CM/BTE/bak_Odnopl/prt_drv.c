...
//        al = (b)(LPC_GPIO2->PIN >> 16)   ;
    al= ((b)(LPC_GPIO2->PIN >> 24) & 0x03)       |   // 0й бит - S3-J1 (PIN-STOP)
       (((b)(LPC_GPIO3->PIN >> 26) & 0x01) << 2) |   // 1й бит - S3-J2
       (((b)(LPC_GPIO3->PIN >> 25) & 0x01) << 3) |   // 2й бит - S3-J3
       (((b)(LPC_GPIO2->PIN >> 10) & 0x0F) << 4) ;   // 3й бит - S3-J4
                                                     // 4й бит - INT0/PRG
                                                     // 5й бит - INT1
                                                     // 6й бит - INT2
                                                     // 7й бит - INT3
    ...
    al =    ((b)(LPC_GPIO1->PIN >> 2 ) & 0x01)       |   // 0й бит - KS - контроль синхронизации
           (((b)(LPC_GPIO1->PIN >> 4 ) & 0x01) << 1) |   // 1й бит - KF - контроль предохранителей
           (((b)(LPC_GPIO0->PIN >>17 ) & 0x01) << 2) ;   // 2й бит - Выход БО
                                                         // 3й бит - отсутствует
                                                         // 4й бит - отсутствует
                                                         // 5й бит - отсутствует
                                                         // 6й бит - отсутствует
...
// заданных уставкой сигналов порта.
  //al = (b)(LPC_GPIO2->PIN >> 16)   ;
    al= ((b)(LPC_GPIO2->PIN >> 24) & 0x03)       |   // 0й бит - S3-J1
       (((b)(LPC_GPIO3->PIN >> 26) & 0x01) << 2) |   // 1й бит - S3-J2
       (((b)(LPC_GPIO3->PIN >> 25) & 0x01) << 3) |   // 2й бит - S3-J3
       (((b)(LPC_GPIO2->PIN >> 10) & 0x0F) << 4) ;   // 3й бит - S3-J4
                                                     // 4й бит - INT0/PRG
...
void  Port_output ( void )
{
  ...
  LPC_GPIO0->PIN = ((lw)(Po0_nm.all & 0x03)) << 18 ;
