...
#define   mPort_Imp( data )  LPC_GPIO3->PIN =(LPC_GPIO3->PIN&0xffC0ffff)|( (data & 0x3F) << 16 )
...
#define  PINSTOP_Msk    (lword)0x01000000 // Порт 2.24
...
#define   mTst_autostart()   (  LPC_GPIO2->PIN & PINSTOP_Msk )
