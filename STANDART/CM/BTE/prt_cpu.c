...
void Init_CPU_Ports( void )
{
 ...
 // P0
    ...
    LPC_IOCON->P0_19  = D_RESERV | D_HYS_EN | D_MODE_PULLDOWN | 0;       // Pi1.7 (INT5)
    LPC_IOCON->P0_20  = D_RESERV | D_HYS_EN | D_MODE_PULLDOWN | 0;       // Pi1.5 (INT6)
    LPC_IOCON->P0_21  = D_RESERV | D_HYS_EN | D_MODE_PULLDOWN | 0;       // Pi1.3 (INT7)
...
// Настройка USEL
    ...
    LPC_IOCON->P1_20 = D_RESERV | D_HYS_EN | D_MODE_PULLDOWN | 0;         // Pi1.1 (FX0)
    LPC_IOCON->P1_23 = D_RESERV | D_HYS_EN | D_MODE_PULLDOWN | 0;         // Pi1.2 (FX1)
    LPC_IOCON->P1_24 = D_RESERV | D_HYS_EN | D_MODE_PULLDOWN | 0;         // Pi1.4 (FZ)
...
// Настройка Input Port 0
    ...
    LPC_IOCON->P2_1   = D_RESERV | 0;       // Po0.6 (PPG5)
    LPC_IOCON->P2_2   = D_RESERV | 0;       // PPG6
    LPC_IOCON->P2_3   = D_RESERV | 0;       // Po0.7 (PPG7)
    ...
    LPC_IOCON->P2_10  = D_RESERV | D_HYS_EN | 0x1;    // Pi2.0 (INT0)
    LPC_IOCON->P2_11  = D_RESERV | D_HYS_EN | 0x1;    // Pi2.1 (INT1)
    LPC_IOCON->P2_12  = D_RESERV | D_HYS_EN | 0x1;    // Pi2.2 (INT2)
    LPC_IOCON->P2_13  = D_RESERV | D_HYS_EN | D_MODE_PULLDOWN | 0;      // Pi1.0 (INT3)
    LPC_IOCON->P2_15  = D_RESERV | D_HYS_EN | D_MODE_PULLDOWN | 0;      // Pi1.4 (INT4)
