...
void  Port_input ( word code )
{
  ...
  {    //  Стартовая инициализация.
    case 0 :
        al = (b)(LPC_GPIO2->PIN >> 16)   ;
        Pi0_c.all = al ;
        Pi0_cf.all = al ;
        Pi0_nm.all = Pi0_f.all = al ^ _r.Pi0_Normal ;
     /*
        al= ((b)(LPC_GPIO0->PIN >> 21) & 0x01)       |   // 0й бит - INT7 - разъём Х12/6   KF
           (((b)(LPC_GPIO2->PIN >> 12) & 0x01) << 1) |   // 1й бит - INT2 -                KFS        для сетевого наездника.
           (((b)(LPC_GPIO0->PIN >> 19) & 0x03) << 2) |   // 2й бит - INT5 - разъём Х15/5   синхр. TCC
                                                         // 3й бит - INT6 - разъём Х15/2   синхр. TCA
           (((b)(LPC_GPIO2->PIN >> 15) & 0x01) << 4) |   // 4й бит - INT4 - разъём Х15/6   синхр. TCB
           (((b)(LPC_GPIO2->PIN >> 13) & 0x01) << 5) |   // 5й бит - INT3 - разъём Х16/6   DI СВ1
           (((b)(LPC_GPIO2->PIN >> 10) & 0x03) << 6) ;   // 6й бит - INT0 - разъём Х18/2   1В
                                                         // 7й бит - INT1 - разъём Х18/4   2В
     */

        al= ((b)(LPC_GPIO2->PIN >> 13) & 0x01)       |   // 0й бит - INT3 - разъём Х16/6   ">"
           (((b)(LPC_GPIO1->PIN >> 20) & 0x01) << 1) |   // 1й бит - FX0  - разъём Х15/3   "Автомат"
           (((b)(LPC_GPIO1->PIN >> 23) & 0x01) << 2) |   // 2й бит - FX0  - разъём Х15/4   "Сушка"
           (((b)(LPC_GPIO0->PIN >> 21) & 0x01) << 3) |   // 3й бит - INT7 - разъём Х12/6   "<"

           (((b)(LPC_GPIO2->PIN >> 15) & 0x01) << 4) |   // 4й бит - INT4 - разъём Х15/6   Резерв
           (((b)(LPC_GPIO0->PIN >> 20) & 0x01) << 5) |   // 5й бит - INT6 - разъём Х15/2   Резерв
           (((b)(LPC_GPIO1->PIN >> 24) & 0x01) << 6) |   // 6й бит - FZ   - разъём Х15/1   KF
           (((b)(LPC_GPIO0->PIN >> 19) & 0x01) << 7);    // 7й бит - INT5 - разъём Х15/5   Резерв
        ...
        al= ((b)(LPC_GPIO2->PIN >> 10) & 0x03)  ;        // 1й бит - INT0 - разъём Х18/2   1В
                                                         // 2й бит - INT1 - разъём Х18/4   2В
        Pi2_c.all = al ;
        Pi2_cf.all = al ;
...
void  Port_output ( void )
{
  ...
  //LPC_GPIO2->PIN = (((lw)(Po0_nm.all & 0x3F)) << 24) ;
asm_di();
  LPC_GPIO2->SET = (((lw)(Po0_nm.all & 0x3F)) << 24) |
                  (((lw)((Po0_nm.all >> 6) & 0x01)) << 1  ) |
                  (((lw)((Po0_nm.all >> 7) & 0x01)) << 3  );
  
  LPC_GPIO2->CLR = ((lw)((~Po0_nm.all) & 0x3F)) << 24 |
                 (((lw)(((~Po0_nm.all) >> 6) & 0x01)) << 1  ) |
                 (((lw)(((~Po0_nm.all) >> 7) & 0x01)) << 3  );
asm_ei();  
