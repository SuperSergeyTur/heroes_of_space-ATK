...
#define _ICS0_PRIORITY   IntPriority(2, 1)  //???
#define _ICS1_PRIORITY   IntPriority(2, 1)  //Us - capture
#define _ICS23_PRIORITY  IntPriority(2, 1)  //CUc - capture
...
#define _OCS5 ( 0x5 )  //LPC_TIM2->MR3
        ...
        // приоритет ЕПА - минимальный возможный.
#define _OCS1_PRIORITY   IntPriority(2, 1) //
#define _OCS2_PRIORITY   IntPriority(2, 1) //
