...
void Init_CPU_Ports( void )
{
 ...
 // P0
    ...
    LPC_IOCON->P0_6   = D_RESERV | W_HYS_EN| 0x2;                 // SSP1_SSEL
    LPC_IOCON->P0_7   = W_RESERV | W_HYS_EN| 0x2;                 // SSP1_SCK 
                                                                        
    LPC_IOCON->P0_8   = W_RESERV | W_HYS_EN| 0x2;                 // SSP1_MISO
    LPC_IOCON->P0_9   = W_RESERV | W_HYS_EN| 0x2;                 // SSP1_MOSI
    LPC_IOCON->P0_10  = D_RESERV | 0;                 // DO0
    LPC_IOCON->P0_11  = D_RESERV | 0;                 // DO1

   // LPC_IOCON->P0_12  = A_RESERV | A_ADMODE_AM   | 0x3;  // ADC6
   // LPC_IOCON->P0_13  = A_RESERV | A_ADMODE_AM   | 0x3;  // ADC7
   // LPC_IOCON->P0_14  = D_RESERV | 0;
   LPC_IOCON->P0_15  = D_RESERV | 0 ;     // DO2
                                  
   LPC_IOCON->P0_16  = D_RESERV | 0 ;       // DO3
   LPC_IOCON->P0_17  = D_RESERV | 0 ;       // DO4
   LPC_IOCON->P0_18  = D_RESERV | 0 ;       // DO5
   ...
   // LPC_IOCON->P0_23  = A_RESERV | A_ADMODE_AM | 0x1;  // ADC0
    ...
    LPC_IOCON->P0_24  = A_RESERV | A_ADMODE_AM | 0x1;  // ADC2
    LPC_IOCON->P0_25  = A_RESERV | A_ADMODE_AM | 0x1;  // ADC3  
   // LPC_IOCON->P0_26  = A_RESERV | A_ADMODE_AM | 0x2;  // DAC
    //LPC_IOCON->P0_27  = I_RESERV | 0;                  //

    //LPC_IOCON->P0_28  = I_RESERV | 0;                  //
    LPC_IOCON->P0_29  = U_RESERV  | 0;    // DIN1
    LPC_IOCON->P0_30  = U_RESERV  | 0;    // DIN2 
  //  LPC_IOCON->P0_31 =  U_RESERV | 0;                  //

    LPC_GPIO0->DIR = 0x00078EC0;

    LPC_IOCON->P1_0  = D_RESERV | 0;       // Avar
    LPC_IOCON->P1_1  = D_RESERV | 0;       // Predupr
//    LPC_IOCON->P1_2  = D_RESERV | 0;         //
//    LPC_IOCON->P1_3  = D_RESERV | 0;         //
   
   LPC_IOCON->P1_4  = D_RESERV | 0;       // USEL
//    LPC_IOCON->P1_5  = D_RESERV | 0;         //
//    LPC_IOCON->P1_6  = D_RESERV | 0;         //
//    LPC_IOCON->P1_7  = D_RESERV | 0;         //
   
    LPC_IOCON->P1_8  = D_RESERV | 0;         //   CS0
    LPC_IOCON->P1_9  = D_RESERV | 0;         //   CS1 
    LPC_IOCON->P1_10 = D_RESERV | 0;         //   CS2 
//    LPC_IOCON->P1_11 = D_RESERV | 0;         //    

//    LPC_IOCON->P1_12 = D_RESERV | 0;         //    
//    LPC_IOCON->P1_13 = D_RESERV | 0;         //
    LPC_IOCON->P1_14 = D_RESERV | 0;         //   CS3
    LPC_IOCON->P1_15 = D_RESERV | 0;         //   CS4 

//    LPC_IOCON->P1_16 = D_RESERV | 0;         //
//    LPC_IOCON->P1_17 = D_RESERV | 0;         //
    LPC_IOCON->P1_18 = D_RESERV | D_HYS_EN | D_MODE_PULLUP | 0;         //DIN3
    LPC_IOCON->P1_19 = D_RESERV | D_HYS_EN | D_MODE_PULLUP | 0;         //DIN4
    
    LPC_IOCON->P1_20 = D_RESERV | D_HYS_EN|D_MODE_PULLUP | 0x3;     // FX0
//    LPC_IOCON->P1_21 = D_RESERV | 0;         //
    LPC_IOCON->P1_22 = D_RESERV | D_HYS_EN | D_MODE_PULLUP | 0;         //DIN5
    LPC_IOCON->P1_23 = D_RESERV | D_HYS_EN|D_MODE_PULLUP | 0x3;     // FX1
    
    LPC_IOCON->P1_24 = D_RESERV | D_HYS_EN|D_MODE_PULLUP | 0x3;     // FZ
    LPC_IOCON->P1_25 = D_RESERV | D_HYS_EN | D_MODE_PULLUP | 0;         //DIN6
    LPC_IOCON->P1_26 = D_RESERV | D_HYS_EN | D_MODE_PULLUP | 0;         //DIN7
    LPC_IOCON->P1_27 = D_RESERV | 0;         //
    
    LPC_IOCON->P1_28 = D_RESERV | D_HYS_EN | D_MODE_PULLUP | 0;         //DIN8
    LPC_IOCON->P1_29 = D_RESERV | 0;                         
    LPC_IOCON->P1_30 = A_RESERV | A_ADMODE_AM   | 0x3; 	     // ADC[4]
    LPC_IOCON->P1_31 = A_RESERV | A_ADMODE_AM   | 0x3; 	     // ADC[5]

    LPC_GPIO1->DIR = 0x2000C713;     //

    //LPC_IOCON->P2_0   = D_RESERV | 0;       
    //LPC_IOCON->P2_1   = D_RESERV | 0;       
    LPC_IOCON->P2_2   = D_RESERV | 0;       // PPG5 
...
/*
    ...
    LPC_IOCON->P4_28  = D_RESERV  | 0 ; //кт1
    LPC_IOCON->P4_29  = D_RESERV  | 0 ; //кт2  
