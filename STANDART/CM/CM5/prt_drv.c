...
void  Port_input ( word code )
{
  ...
  {    //  Стартовая инициализация.
    case 0 :
        al = (b)(((LPC_GPIO0->PIN >> 29)&0x3)| (((LPC_GPIO1->PIN >> 18)&0x3)<<2) 
              |(((LPC_GPIO1->PIN >> 22)&0x1)<<4) | (((LPC_GPIO1->PIN >> 25)&0x3)<<5)
                | (((LPC_GPIO1->PIN >> 28)&0x1)<<7))  ;
        Pi0_c.all = al ;
        Pi0_cf.all = al ;
...
// заданных уставкой сигналов порта.
     al = (b)(((LPC_GPIO0->PIN >> 29)&0x3)| (((LPC_GPIO1->PIN >> 18)&0x3)<<2) 
           |(((LPC_GPIO1->PIN >> 22)&0x1)<<4) | (((LPC_GPIO1->PIN >> 25)&0x3)<<5)
             | (((LPC_GPIO1->PIN >> 28)&0x1)<<7))  ;
    //read_write_ssio(LPC_SSP_TypeDef *SSPx, word in)
...
void  Port_output ( void )
{
  ...
  lax = (((lw)(Po0_nm.all & 0x3)<<10)|((lw)(Po0_nm.all & 0x3c)<<13));
  LPC_GPIO0->SET = lax;
  LPC_GPIO0->CLR = ~lax&((lw)0x00078c00);//&((lw)0x00078c00); //P0.b10,P0.b11, P0.b15- P0.b18
  lax = (Po0_nm.all&0xc0)>>6;
  LPC_GPIO1->SET = lax&0x3;  //b6- R_LED, b7 - Y_LED 
  LPC_GPIO1->CLR = ~lax&0x3; //
