...
#define  _Q1_Msk		(0x1UL<<31)  // Порт P2.30
#define  _Q2_Msk		(0x1UL<<30)  // Порт P2.31

#define   mSET_Q1()    LPC_GPIO2->CLR = _Q1_Msk
#define   mCLR_Q1()    LPC_GPIO2->SET = _Q1_Msk

#define   mSET_Q2()    LPC_GPIO2->CLR = _Q2_Msk
#define   mCLR_Q2()    LPC_GPIO2->SET = _Q2_Msk
...
#define  USEL_Msk		(lword)0x1<<7 // Порт 2.7
#define  PINSTOP_Msk	(lword)0x1<<20 // Порт 0.20

#define   mUSEL_set()  LPC_GPIO2->CLR = USEL_Msk
#define   mUSEL_clr()  LPC_GPIO2->SET = USEL_Msk
static __INLINE void mUSEL_not()
{
  if ( (LPC_GPIO2->PIN & USEL_Msk) == 0 )
  {
	 mUSEL_clr();
  }
  else
...
#define    USEL     ((LPC_GPIO2->PIN &= USEL_Msk) != 0)

#define   mTst_autostart()   (  LPC_GPIO0->PIN & PINSTOP_Msk )
