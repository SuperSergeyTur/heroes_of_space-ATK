...
void Init_CPU_Ports( void )
{
 ...
 // P0
    ...
    LPC_IOCON->P0_0   = D_RESERV | 0;                   //
    LPC_IOCON->P0_1   = D_RESERV | 0;                   //
    ...
    LPC_IOCON->P0_6   = D_RESERV | 0;
    LPC_IOCON->P0_7   = W_RESERV | 0;

    LPC_IOCON->P0_8   = W_RESERV | 0;
    LPC_IOCON->P0_9   = W_RESERV | 0;
    ...
    LPC_IOCON->P0_15  = D_RESERV | D_MODE_PULLUP |0x2;      // SCK_SPI1

    LPC_IOCON->P0_16  = D_RESERV | D_MODE_PULLUP |0x2;      //  CS_SPI1
    LPC_IOCON->P0_17  = D_RESERV | D_MODE_PULLUP |0x2;      //MISO_SPI1
    LPC_IOCON->P0_18  = D_RESERV | D_MODE_PULLUP |0x2;      //MOSI_SPI1
    ...
    LPC_IOCON->P0_29  = U_RESERV | 0x2;                // EINT0
    LPC_IOCON->P0_30  = U_RESERV | 0x2;                // EINT1
    LPC_IOCON->P0_31 =  U_RESERV | 0;                  //

    LPC_GPIO0->DIR = 0;

    LPC_IOCON->P1_0  = D_RESERV | D_MODE_PULLUP | 0x4;       // SCK_SPI0
    LPC_IOCON->P1_1  = D_RESERV | D_MODE_PULLUP | 0x4;       // MOSI_SPI0
    LPC_IOCON->P1_2  = D_RESERV | 0;         //
    LPC_IOCON->P1_3  = D_RESERV | 0;         //
    LPC_IOCON->P1_4  = D_RESERV | D_MODE_PULLUP | 0x4;       // MISO_SPI1
    LPC_IOCON->P1_5  = D_RESERV | 0;         //
    LPC_IOCON->P1_6  = D_RESERV | 0;         //
    LPC_IOCON->P1_7  = D_RESERV | 0;         //
    LPC_IOCON->P1_8  = D_RESERV | D_MODE_PULLUP | 0x4;       // CS_SPI1
    ...
    LPC_IOCON->P2_0   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       // in0
    LPC_IOCON->P2_1   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       // in1
    LPC_IOCON->P2_2   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       // in2
    LPC_IOCON->P2_3   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       // in3
    LPC_IOCON->P2_4   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       // in4
    LPC_IOCON->P2_5   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       // in5
    LPC_IOCON->P2_6   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       //J1
    LPC_IOCON->P2_7   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       //J2
    LPC_IOCON->P2_8   = D_RESERV | D_MODE_PULLUP |D_HYS_EN | 0;       //J3
