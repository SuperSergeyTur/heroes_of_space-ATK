...
#else
    LPC_IOCON->P1_20 = D_RESERV | D_HYS_EN | 0;         // FX0
    LPC_IOCON->P1_23 = D_RESERV | D_HYS_EN | 0;         // FX1
    LPC_IOCON->P1_24 = D_RESERV | D_HYS_EN | 0;         // FZ
#endif
    LPC_IOCON->P1_30 = A_RESERV | A_ADMODE_AM | 0x3; 	// ADC4
    LPC_IOCON->P1_31 = A_RESERV | A_ADMODE_AM | 0x3; 	// ADC5

    LPC_GPIO1->DIR |= 0x3240007e;     //
    LPC_GPIO1->SET  = 0x00000012;     // Усмтановка сигналов Q1V и Q2V в 1 .
...
// Настройка Input Port 0
    ...
    LPC_IOCON->P2_1   = D_RESERV | 0;       // PPG6
    LPC_IOCON->P2_2   = D_RESERV | 0;       // PPG5 - Если запайка #4:1-2
...
#ifdef  _GERCON_INT3_    // для БСВ прерывание по геркону
