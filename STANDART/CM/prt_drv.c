...
void  Port_input ( word code )
{
  ...
  {    //  Стартовая инициализация.
    case 0 :
        ...
        al= ((b)(LPC_GPIO0->PIN >> 21) & 0x01)       |   // 0й бит - INT7 - разъём Х12/6
           (((b)(LPC_GPIO2->PIN >> 12) & 0x01) << 1) |   // 1й бит - INT2 - для сетевого наездника .
           (((b)(LPC_GPIO0->PIN >> 19) & 0x03) << 2) |   // 2й бит - INT5 - разъём Х15/5
                                                         // 3й бит - INT6 - разъём Х15/2
           (((b)(LPC_GPIO2->PIN >> 15) & 0x01) << 4) |   // 4й бит - INT4 - разъём Х15/6
           (((b)(LPC_GPIO2->PIN >> 13) & 0x01) << 5) |   // 5й бит - INT3 - разъём Х16/6
           (((b)(LPC_GPIO2->PIN >> 10) & 0x03) << 6) ;   // 6й бит - INT0 - разъём Х18/2
