...
byte read_Pi1 ( void )
{
  register byte al ;
          //
          //         ЪДДДДДДДДДДДДДДДДДДДДДДДДДP22
          //         і       ЪДДДДДДДДДДДДДДДДДP20
          //         і       і         ЪДДДДДДДP13...P10
          //         і       і   ЪДДДДДБДДДДДї
          //   ЪДДДВДБДВДДДВДБДТДБДВДДДВДДДВДБДї
          //   і 7 і 6 і 5 і 4 є 3 і 2 і 1 і 0 і
          //   АДДДБДДДБДДДБДДДРДДДБДДДБДДДБДДДЩ

          //    P22...P20            P13...P10
        al = ((PDR2 & 0x05)<<4 ) | (PDR1 & 0x0F) ;
