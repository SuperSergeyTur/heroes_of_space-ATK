...
/* Диагаамма аабовл дилмваа даебезга и помее.
  ...
  ННОНННПНННПННННПНННННННПНПННННННННННННННННННННННННННННННННННННННННННННННННПН>
      ...
      є                            і                                      і
     є                            і                                      і
  ННОННННННННННННННННННННННННННННПННННННННННННННННННННННННННННННННННННННПН>
   є                                                                     t,o.e.
*/
//--------------------------------------------------------
...
void  Port_output ( void )
{
  ...
  if (Po0_c._.n3 ) PDR1_P10 = 1;
  else PDR1_P10 = 0;

#endif
  if (Po0_c._.n4 ) PDR1_P11 = 1;
  else PDR1_P11 = 0;
  if (Po0_c._.n5 ) PDR1_P12 = 1;
  else PDR1_P12 = 0;
  if (Po0_c._.n6 ) PDR1_P13 = 1;
  else PDR1_P13 = 0;
