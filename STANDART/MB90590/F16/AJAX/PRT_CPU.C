...
void  Init_CPU_Ports ( void )
{
  __set_il(7);       // маска запросов прерываний - все разрешены
    ...
    //   В "PDRx": начальное значение выходного сигнала - 1 или 0.
               ...
               // DDR/PDR
  DDR0 = 0xC4 ;  // 0/0  P0.0...P0.1 - входы режима программирования.
  ...
  #define  _ext_pdr2  0x00
#endif
DDR2 = _ext_ddr2;// 1/0  P2.0...P2.3 - выходные (и.п.'0').
PDR2 = _ext_pdr2;// 0/0  P2.4...P2.7 - входные дискретные сигналы.
