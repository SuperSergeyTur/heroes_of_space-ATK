...
void  Init_CPU_Ports ( void )
{
  ...
  DDR1 = 0x6F ;  // 1/0  P1.0...P1.1 - не используется.              BTE с расцепителем =220В
  PDR1 = 0x38;   // 1/0  P1.2        - выходной дискретный сигнал.   0x30
                 // 1/1  P1.3        - выходной Q1-сигнал.           1/0
                 // 0/1  P1.4        - CAN1: RXC1.
                 // 1/1  P1.5        - CAN1: TXC1.
                 // 1/0  P1.6        - USEL.
                 // 0/0  P1.7        - ОСТАНОВ.
  ...
  #define  _ext_ddr2  0xC3
  #define  _ext_pdr2  0xC3
#endif
DDR2 = _ext_ddr2;// 1/1  P2.0...P2.1 - выходные ИУ тормозом (и.п.'1').
PDR2 = _ext_pdr2;// 0/0  P2.2...P2.5 - неиспольз. или входные дискретные сигналы.
  ...
  PDR5 = 0x00;   //  PPG1   - выходной дискретный сигнал.   (и.п.'0').
                 ...
                 //  0/0  P5.6       - входной дискретный сигнал.
