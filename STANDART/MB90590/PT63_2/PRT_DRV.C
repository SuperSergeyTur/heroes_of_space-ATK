...
{
  union Prt  po0_c ; /* отнормированное состояние порта, выводимое в выходной порт. */


    // Из всего порта используются только четыре разряда.
  //PDR3 = Po0_c.all & 0x0F ;

  po0_c.all = Po0_c.all ^ _r.Po0_Normal ; // Нормализация выходных сигналов .
